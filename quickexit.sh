...
'\''3i 	EO(qe),
??!219reg ex.c:1745:m32sc %? %@2142sc!b2m!%ya 98?0?
...
index a2bf8821..fe22dece 100644
--- a/conf.c
+++ b/conf.c
...
index f049069e..ca7fd8c2 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1674,6 +1675,7 @@ static void *eo_##opt(char *loc, char *cmd, char *arg) { inner }
...
@@ -1743,6 +1745,7 @@ static struct excmd {
 	EO(mpt),
 	{"m!", ec_mark},
 	{"m", ec_mark},
+	EO(qe),
