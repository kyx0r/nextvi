...
grp 1%f+ 	EO\(mpt\),.*?
	\{"m!", ec_mark},.*?
(	\{"m", ec_mark},)7??0?
grp 07??m 3220reg p OK ex.c:1730:a72sc %? %@2152sc!1q0?
...
index bf37a9ce..8123690b 100644
--- a/conf.c
+++ b/conf.c
...
index 4efc8c2e..107f9474 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1660,6 +1661,7 @@ static void *eo_##opt(char *loc, char *cmd, char *arg) { inner }
...
@@ -1728,6 +1730,7 @@ static struct excmd {
 	EO(mpt),
 	{"m!", ec_mark},
 	{"m", ec_mark},
+	EO(qe),
