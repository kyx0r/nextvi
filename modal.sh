...
${SEP}${LB}
${SEP}'0s/mj\\]/j]|md?/${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL conf.c:296:m0${ESC}${SEP}pr${INTR}${QF2}}${SEP}b1${SEP}%ya b${SEP}?%;f> 	return NULL;
\\)
...
${ESC}${SEP}1${ESC}?${ESC}?${ESC}${SEP}1${ESC}?${ESC}?+2m 0${ESC}${ESC}${ESC}${SEP}${OK1}p OK ex.c:1512:a1${SEP}${LB}
...
${SEP}?%;f+ 	\\{\"g!\", ec_glob},
	...
	\\{\"g\", ec_glob},
	EO\\(mpt\\),${ESC}${SEP}1${ESC}?${ESC}?${ESC}${SEP}1${ESC}?${ESC}?+2m 1${ESC}${ESC}${ESC}${SEP}${OK1}p OK ex.c:1564:a1${SEP}${LB}
...
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1512:m0${ESC}${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a 	{\"md\", ec_modal},
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1564:m1${ESC}${SEP}pr${INTR}${QF2}}${SEP}b2${SEP}${LB}
...
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL modal.c:-1:m${ESC}${SEP}pr${INTR}${QF2}}${SEP}b3${SEP}${LB}
${SEP}i <> (?0 ?: ?1) (?:)
<> (out (?x)) (\$p ?x)

(out (3 + 9 - 5 + 23 / 10))
(out (asd3+9))
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL test:-1:m${ESC}${SEP}pr${INTR}${QF2}}${SEP}b4${SEP}%ya b${SEP}?%;f> #include <sys/wait\\.h>
#include \"vi\\.h\"
#include \"conf\\.c\"
#include \"ex\\.c\"
#include \"lbuf\\.c\"
...
${SEP}0;1??!${DBG1:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL vi.c:17${ESC}${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}${LB}
${SEP}'0a #include \"modal.c\"
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL vi.c:17:m0${ESC}${SEP}pr${INTR}${QF2}}${SEP}vis 2${SEP}b0${SEP}w${SEP}b1${SEP}w${SEP}b2${SEP}w${SEP}b3${SEP}w${SEP}b4${SEP}w${SEP}q" $VI -e 'conf.c' 'ex.c' 'modal.c' 'test' 'vi.c'
...
index 253b954c..1e7bf736 100644
--- a/ex.c
+++ b/ex.c
@@ -1510,6 +1510,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1562,6 +1610,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
