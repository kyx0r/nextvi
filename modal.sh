...
'\''1s/m!/m[!d]/??!219reg conf.c:301:m12sc %? %@2142sc!b1m!%ya 98?0?
%f> 	return NULL;
\)
...
4??0?
4??+2m 1220reg p OK ex.c:1701:a42sc %? %@2152sc!1q0?
...
static struct excmd \{
	char \*name;8??0?
grp 08??-4m 1220reg p OK ex.c:1701:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);
	else if \(\*arg\).*(	void \*\(\*ec\)\(char \*loc, char \*cmd, char \*arg\);)
} excmds\[] = \{
	\{"@", ec_termexec},9??0?
grp 09??-7m 1220reg p OK ex.c:1701:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"g!", ec_glob},
	\{"g", ec_glob},
	EO\(mpt\),4??0?
4??+2m 2220reg p OK ex.c:1754:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"g!", ec_glob},.*?
	\{"g", ec_glob},.*?
(	EO\(mpt\),)7??0?
grp 07??m 2220reg p OK ex.c:1754:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"i", ec_insert},
	\{"d", ec_delete},
	EO\(grp\),.*(	\{"q", ec_quit},)
	\{"reg\+", ec_regprint},
	\{"reg", ec_regprint},8??0?
grp 08??-4m 2220reg p OK ex.c:1754:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(ish\),
	\{"inc", ec_setincl},
	EO\(ic\),.*(	\{"re", ec_krsset},)
	\{"rd", ec_undoredo},
	EO\(rr\),9??0?
grp 09??-7m 2220reg p OK ex.c:1754:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1701:m12sc %? %@2142sc!0?
'\''2i 	{"md", ec_modal},
??!219reg ex.c:1754:m22sc %? %@2142sc!b2m!0?
i #include <stdio.h>
...
??!219reg modal.c:-1:m2sc %? %@2142sc!b3m!0?
i <> (?0 ?: ?1) (?:)
<> (out (?x)) ($p ?x)

(out (3 + 9 - 5 + 23 / 10))
(out (asd3+9))
??!219reg test:-1:m2sc %? %@2142sc!b4m!%ya 98?0?
...
index c92ec213..b1aa3301 100644
--- a/conf.c
+++ b/conf.c
@@ -298,7 +298,7 @@ return|select|switch|type|var))\\>", A(GR1, BL1 | SYN_BD, YE1)},
 ...
 ((pac|pr|ai|ish|err|fr|ic|grp|mpt|rr|shape|seq|ts|td|order|hl[lwpr]?|left|lim|led|vis)\
-|[@&!dj]|m!?|=\\?{0,1}|\\?~|\\?{1,2}[?!]?|b[psx]?|p[uh]?|ac|e[f!]?!?|f[-+><tdp]?|inc|i|sc!?|\
+|[@&!dj]|m[!d]?|=\\?{0,1}|\\?~|\\?{1,2}[?!]?|b[psx]?|p[uh]?|ac|e[f!]?!?|f[-+><tdp]?|inc|i|sc!?|\
 (?:g!?|s)[ \t]?(.)?|q!?|reg?\\+?|rd?|w(?:q!|[q!])?|u[czbd]|x!?|ya[!+]?|cm!?|cd?)?",
 		A(BL1 | SYN_BD, RE, RE, RE, RE, WH1, MA1, RE, RE, WH1, RE, GR1, CY1, MA1)},
 	{ex_ft, "\\\\(.)", A(AY1 | SYN_BD, YE)},
diff --git a/ex.c b/ex.c
index 9edd2405..b0cce24c 100644
--- a/ex.c
+++ b/ex.c
@@ -1699,6 +1699,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1752,6 +1800,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
...
index b5e0f21b..c1f033a3 100644
--- a/vi.c
+++ b/vi.c
@@ -15,6 +15,7 @@
 #include <sys/wait.h>
