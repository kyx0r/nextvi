...
4??0?
4??+2m 1220reg p OK ex.c:1727:a42sc %? %@2152sc!1q0?
...
static struct excmd \{
	char \*name;8??0?
grp 08??-4m 1220reg p OK ex.c:1727:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);
	else if \(\*arg\).*(	void \*\(\*ec\)\(char \*loc, char \*cmd, char \*arg\);)
} excmds\[] = \{
	\{"@", ec_termexec},9??0?
grp 09??-7m 1220reg p OK ex.c:1727:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"g!", ec_glob},
	\{"g", ec_glob},
	EO\(mpt\),4??0?
4??+2m 2220reg p OK ex.c:1780:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"g!", ec_glob},.*?
	\{"g", ec_glob},.*?
(	EO\(mpt\),)7??0?
grp 07??m 2220reg p OK ex.c:1780:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"i", ec_insert},
	\{"d", ec_delete},
	EO\(grp\),.*(	\{"q", ec_quit},)
	\{"reg\+", ec_regprint},
	\{"reg", ec_regprint},8??0?
grp 08??-4m 2220reg p OK ex.c:1780:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(ish\),
	\{"inc", ec_setincl},
	EO\(ic\),.*(	\{"re", ec_krsset},)
	\{"rd", ec_undoredo},
	EO\(rr\),9??0?
grp 09??-7m 2220reg p OK ex.c:1780:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1727:m12sc %? %@2142sc!0?
'\''2i 	{"md", ec_modal},
??!219reg ex.c:1780:m22sc %? %@2142sc!b2m!0?
i #include <stdio.h>
...
index 0ce81414..c3066114 100644
--- a/ex.c
+++ b/ex.c
@@ -1725,6 +1725,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1778,6 +1826,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
...
index 03ed7b03..d7207185 100644
--- a/vi.c
+++ b/vi.c
@@ -15,6 +15,7 @@
 #include <sys/wait.h>
