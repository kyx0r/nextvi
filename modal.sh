...
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1558:m0${ESC}${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a 	{\"md\", ec_modal},
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1610:m1${ESC}${SEP}pr${INTR}${QF2}}${SEP}b2${SEP}${LB}
