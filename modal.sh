...
static struct excmd \{
	char \*name;8??0?
grp 08??-4m 1220reg p OK ex.c:1660:a82sc %? %@2152sc!'\''08??1q0?
...
grp 1%f+ 	\{"g!", ec_glob},.*?
	\{"g", ec_glob},.*?
(	EO\(mpt\),)7??0?
grp 07??m 2220reg p OK ex.c:1712:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"i", ec_insert},
	\{"d", ec_delete},
	EO\(grp\),.*(	\{"reg\+", ec_regprint},)
	\{"reg", ec_regprint},
	\{"re", ec_krsset},8??0?
grp 08??-4m 2220reg p OK ex.c:1712:a82sc %? %@2152sc!'\''08??1q0?
...
??!219reg ex.c:1660:m12sc %? %@2142sc!0?
'\''2i 	{"md", ec_modal},
??!219reg ex.c:1712:m22sc %? %@2142sc!b20?
i #include <stdio.h>
...
index 92efe600..0ec52f2c 100644
--- a/ex.c
+++ b/ex.c
@@ -1658,6 +1658,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1710,6 +1758,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
