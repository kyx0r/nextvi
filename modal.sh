...
'\''1s/mj]/j]|md?/??!219reg conf.c:301:m12sc %? %@2142sc!b1m!%ya 98?0?
%f> 	return NULL;
\)
...
4??0?
4??+2m 1220reg p OK ex.c:1667:a42sc %? %@2152sc!1q0?
...
static struct excmd \{
	char \*name;8??0?
grp 08??-4m 1220reg p OK ex.c:1667:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);
	else if \(\*arg\).*(	void \*\(\*ec\)\(char \*loc, char \*cmd, char \*arg\);)
} excmds\[] = \{
	\{"@", ec_termexec},9??0?
grp 09??-7m 1220reg p OK ex.c:1667:a92sc %? %@2152sc!'\''00?
...
m 01;0grp 1%f> 	\{"i", ec_insert},
	...
	\{"reg", ec_regprint},
	\{"re", ec_krsset},8??0?
grp 08??-4m 2220reg p OK ex.c:1719:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(ish\),
	\{"inc", ec_setincl},
	EO\(ic\),.*(	\{"rd", ec_undoredo},)
	EO\(rr\),
	\{"r", ec_read},9??0?
grp 09??-7m 2220reg p OK ex.c:1719:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1667:m12sc %? %@2142sc!0?
'\''2i 	{"md", ec_modal},
??!219reg ex.c:1719:m22sc %? %@2142sc!b2m!0?
i #include <stdio.h>
...
index c10d3ad5..8cceb444 100644
--- a/ex.c
+++ b/ex.c
@@ -1665,6 +1665,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1717,6 +1765,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
