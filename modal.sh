...
${ESC}${SEP}1${ESC}?${ESC}?${ESC}${SEP}1${ESC}?${ESC}?+2m 0${ESC}${ESC}${ESC}${SEP}${OK1}p OK ex.c:1509:a1${SEP}${LB}
...
${SEP}?%;f+ 	\\{\"g!\", ec_glob},
	...
	\\{\"g\", ec_glob},
	EO\\(mpt\\),${ESC}${SEP}1${ESC}?${ESC}?${ESC}${SEP}1${ESC}?${ESC}?+2m 1${ESC}${ESC}${ESC}${SEP}${OK1}p OK ex.c:1561:a1${SEP}${LB}
...
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1509:m0${ESC}${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a 	{\"md\", ec_modal},
${SEP}??!${DBG2:-ya!p${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1561:m1${ESC}${SEP}pr${INTR}${QF2}}${SEP}b2${SEP}${LB}
...
index d8967839..7a36433e 100644
--- a/conf.c
+++ b/conf.c
...
index bc6a6269..2cd51347 100644
--- a/ex.c
+++ b/ex.c
@@ -1507,6 +1507,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1559,6 +1607,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
