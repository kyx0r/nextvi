...
${SEP}+3m 0${SEP}${LB}
${SEP}'0s/mj\\\\]/j]|md?/${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL conf.c:296:m0\\${SEP}pr${INTR}${QF2}}${SEP}b1${SEP}%ya b${SEP}%;f> 	return NULL;
\\\\)
...
${SEP}'1a 	{\"md\", ec_modal},
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1561:m1\\${SEP}pr${INTR}${QF2}}${SEP}b2${SEP}${LB}
...
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL modal.c:-1:m\\${SEP}pr${INTR}${QF2}}${SEP}b3${SEP}${LB}
${SEP}i <> (?0 ?: ?1) (?:)
<> (out (?x)) (\$p ?x)

(out (3 + 9 - 5 + 23 / 10))
(out (asd3+9))
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL test:-1:m\\${SEP}pr${INTR}${QF2}}${SEP}b4${SEP}%ya b${SEP}%;f> #include <sys/wait\\\\.h>
#include \"vi\\\\.h\"
#include \"conf\\\\.c\"${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL vi.c:17\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 0${SEP}${LB}
${SEP}'0a #include \"modal.c\"
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL vi.c:17:m0\\${SEP}pr${INTR}${QF2}}${SEP}vis 2${SEP}b0${SEP}w${SEP}b1${SEP}w${SEP}b2${SEP}w${SEP}b3${SEP}w${SEP}b4${SEP}w${SEP}q" $VI -e 'conf.c' 'ex.c' 'modal.c' 'test' 'vi.c'
