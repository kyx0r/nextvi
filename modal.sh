...
static struct excmd \{
	char \*name;8??0?
grp 08??-4m 1220reg p OK ex.c:1666:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);
	else if \(\*arg\).*(	void \*\(\*ec\)\(char \*loc, char \*cmd, char \*arg\);)
} excmds\[] = \{
	\{"@", ec_termexec},9??0?
grp 09??-7m 1220reg p OK ex.c:1666:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"g!", ec_glob},
	\{"g", ec_glob},
	EO\(mpt\),4??0?
4??+2m 2220reg p OK ex.c:1718:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"g!", ec_glob},.*?
	\{"g", ec_glob},.*?
(	EO\(mpt\),)7??0?
grp 07??m 2220reg p OK ex.c:1718:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"i", ec_insert},
	\{"d", ec_delete},
	EO\(grp\),.*(	\{"reg\+", ec_regprint},)
	\{"reg", ec_regprint},
	\{"re", ec_krsset},8??0?
grp 08??-4m 2220reg p OK ex.c:1718:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(ish\),
	\{"inc", ec_setincl},
	EO\(ic\),.*(	\{"rd", ec_undoredo},)
	EO\(rr\),
	\{"r", ec_read},9??0?
grp 09??-7m 2220reg p OK ex.c:1718:a92sc %? %@2152sc!'\''00?
...
'\''2i 	{"md", ec_modal},
??!219reg ex.c:1718:m22sc %? %@2142sc!b20?
i #include <stdio.h>
...
index 8fabb849..70a584ef 100644
--- a/ex.c
+++ b/ex.c
@@ -1664,6 +1664,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1716,6 +1764,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
