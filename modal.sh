...
4??0?
4??+2m 1220reg p OK ex.c:1729:a42sc %? %@2152sc!1q0?
...
static struct excmd \{
	char \*name;8??0?
grp 08??-4m 1220reg p OK ex.c:1729:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);
	else if \(\*arg\).*(	void \*\(\*ec\)\(char \*loc, char \*cmd, char \*arg\);)
} excmds\[] = \{
	\{"@", ec_termexec},9??0?
grp 09??-7m 1220reg p OK ex.c:1729:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1729:m12sc %? %@2142sc!0?
'\''2i 	{"md", ec_modal},
??!219reg ex.c:1782:m22sc %? %@2142sc!b2m!0?
i #include <stdio.h>
...
index 6908c52d..937e7ab9 100644
--- a/ex.c
+++ b/ex.c
@@ -1727,6 +1727,54 @@ _EO(left,
 	return NULL;
 )
...
@@ -1780,6 +1828,7 @@ static struct excmd {
 	{"g!", ec_glob},
 	{"g", ec_glob},
 	EO(mpt),
+	{"md", ec_modal},
...
index 09100cde..19935bb2 100644
--- a/vi.c
+++ b/vi.c
@@ -15,6 +15,7 @@
 #include <sys/wait.h>
