...
4??0?
4??+2m 2220reg p OK ex.c:1703:a42sc %? %@2152sc!1q0?
...
grp 08??-5m 2220reg p OK ex.c:1703:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		x->att\[j\+1] = syn_merge\(x->att\[j\+1], conf_hlrev\);
	}
}.*(	if \(xhlr && !p\))
		led_extreg\(\)->ext_func = ext_hlr;
	else if \(!xhlr && p\)9??0?
grp 09??-8m 2220reg p OK ex.c:1703:a92sc %? %@2152sc!'\''00?
1;4;8;9??!219reg ex.c:17032sc %? %@2132sc!0?
?0?
%f+ 	EO\(ts\),
	EO\(td\),
	EO\(order\),
...
%f+ 	EO\(ts\),
	EO\(td\),
	EO\(order\),4??0?
4??+2m 3220reg p OK ex.c:1816:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(ts\),.*?
	EO\(td\),.*?
(	EO\(order\),)7??0?
grp 07??m 3220reg p OK ex.c:1816:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"cd", ec_chdir},
	\{"c", ec_insert},
	\{"j", ec_join},.*(	EO\(hlr\),)
	EO\(hl\),
	EO\(left\),8??0?
grp 08??-4m 3220reg p OK ex.c:1816:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"ya", ec_yank},
	\{"cm!", ec_cmap},
	\{"cm", ec_cmap},.*(	EO\(lim\),)
	EO\(led\),
	EO\(vis\),9??0?
grp 09??-7m 3220reg p OK ex.c:1816:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:18162sc %? %@2132sc!0?
'\''1i int xhlm;			/* highlight marks */
??!219reg ex.c:9:m12sc %? %@2142sc!0?
'\''2i EO(hlm)
??!219reg ex.c:1703:m22sc %? %@2142sc!0?
'\''3i 	EO(hlm),
??!219reg ex.c:1816:m32sc %? %@2142sc!b2m!%ya 98?0?
%f> 				word = cs;
			}
		}
...
index 0ce81414..452f8553 100644
--- a/ex.c
+++ b/ex.c
...
@@ -1701,6 +1702,7 @@ EO(pac) EO(pr) EO(ai) EO(err) EO(fr) EO(ish) EO(ic) EO(mpt)
...
@@ -1814,6 +1816,7 @@ static struct excmd {
 	EO(ts),
 	EO(td),
 	EO(order),
+	EO(hlm),
...
index 9ca49dbb..5422b959 100644
--- a/vi.c
+++ b/vi.c
