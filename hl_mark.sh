...
${SEP}+1${SEP}s/wp/wmp/${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL conf.c:295\\${SEP}pr${INTR}${QF}}${SEP}b1${SEP}%;f> int xhlw;			/\\\\* highlight current word \\\\*/
...
index f4366df9..1850ec4c 100644
--- a/conf.c
+++ b/conf.c
...
index 0ec68c95..0fca52ee 100644
--- a/ex.c
+++ b/ex.c
