...
${SEP}+1m 0${SEP}${LB}
${SEP}'0s/wp/wmp/${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL conf.c:295:m0\\${SEP}pr${INTR}${QF2}}${SEP}b1${SEP}%ya b${SEP}%;f> int xhlw;			/\\\\* highlight current word \\\\*/
int xhlp;			/\\\\* highlight \\\\{}\\\\[\\\\]\\\\(\\\\) pair \\\\*/
int xhlr;			/\\\\* highlight text in reverse direction \\\\*/${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:9\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 0${SEP};0${SEP}0reg${SEP}.,\$f+ EO\\\\(pac\\\\)${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1496\\${SEP}pr${INTR}${QF1}}${SEP}98reg${SEP}${LB}
${SEP}+2m 1${SEP}%;f+ 	EO\\\\(ts\\\\),
	EO\\\\(td\\\\),
	EO\\\\(order\\\\),${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1594\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 2${SEP}${LB}
${SEP}'0a int xhlm;			/* highlight marks */
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:9:m0\\${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a EO(hlm)
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1496:m1\\${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'2a 	EO(hlm),
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1594:m2\\${SEP}pr${INTR}${QF2}}${SEP}b2${SEP}%ya b${SEP}%;f> 				word = cs;
			}
		}${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL vi.c:1757\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 0${SEP}${LB}
${SEP}'0a 		if (xhlm) {
			int mrow, moff;
...
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL vi.c:1757:m0\\${SEP}pr${INTR}${QF2}}${SEP}vis 2${SEP}b0${SEP}w${SEP}b1${SEP}w${SEP}b2${SEP}w${SEP}q" $VI -e 'conf.c' 'ex.c' 'vi.c'
