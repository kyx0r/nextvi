...
%f+ 	EO\(ts\),
	EO\(td\),
	EO\(order\),4??0?
4??+2m 3220reg p OK ex.c:1779:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(ts\),.*?
	EO\(td\),.*?
(	EO\(order\),)7??0?
grp 07??m 3220reg p OK ex.c:1779:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"cd", ec_chdir},
	\{"c", ec_insert},
	\{"j", ec_join},.*(	EO\(hlr\),)
	EO\(hl\),
	EO\(left\),8??0?
grp 08??-4m 3220reg p OK ex.c:1779:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"ya", ec_yank},
	\{"cm!", ec_cmap},
	\{"cm", ec_cmap},.*(	EO\(lim\),)
	EO\(led\),
	EO\(vis\),9??0?
grp 09??-7m 3220reg p OK ex.c:1779:a92sc %? %@2152sc!'\''00?
...
'\''3i 	EO(hlm),
??!219reg ex.c:1779:m32sc %? %@2142sc!b2m!%ya 98?0?
%f> 				word = cs;
			}
		}
...
index a2bf8821..ef828300 100644
--- a/conf.c
+++ b/conf.c
...
index f049069e..88a13a4e 100644
--- a/ex.c
+++ b/ex.c
...
@@ -1777,6 +1779,7 @@ static struct excmd {
 	EO(ts),
 	EO(td),
 	EO(order),
+	EO(hlm),
