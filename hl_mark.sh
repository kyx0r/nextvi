...
'\''1s/wp/wmp/??!219reg conf.c:300:m12sc %? %@2142sc!b1m!%ya 98?0?
...
%f+ 	EO\(ts\),
	EO\(td\),
	EO\(order\),4??0?
4??+2m 3220reg p OK ex.c:1764:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(ts\),.*?
	EO\(td\),.*?
(	EO\(order\),)7??0?
...
'\''3i 	EO(hlm),
??!219reg ex.c:1764:m32sc %? %@2142sc!b2m!%ya 98?0?
%f> 				word = cs;
			}
		}
...
index bf37a9ce..5039affc 100644
--- a/conf.c
+++ b/conf.c
...
index 4efc8c2e..058f0766 100644
--- a/ex.c
+++ b/ex.c
...
@@ -1762,6 +1764,7 @@ static struct excmd {
 	EO(ts),
 	EO(td),
 	EO(order),
+	EO(hlm),
