...
${SEP}+3${SEP}s/t\\\\|s/t|rec|s/${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL conf.c:292\\${SEP}pr${INTR}${QF}}${SEP}b1${SEP}i int xrec;			/* input recoding register */
${SEP}%f> EO\\\\(pac\\\\)${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1463\\${SEP}pr${INTR}${QF}}${SEP}${LB}
${SEP}+2a EO(rec)
${SEP}.,\$f> 	\\\\{\"q\", ec_quit\\\\},${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1531\\${SEP}pr${INTR}${QF}}${SEP}${LB}
${SEP}.a 	EO(rec),
${SEP}b2${SEP}%;f> 		ret:
		ibuf_cnt = 1;
...
index 37836e80..126769a4 100644
--- a/conf.c
+++ b/conf.c
...
index 7aae6489..88c298ce 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+int xrec;			/* input recoding register */
...
@@ -1529,6 +1531,7 @@ static struct excmd {
 	{"m", ec_mark},
 	{"q!", ec_quit},
 	{"q", ec_quit},
+	EO(rec),
