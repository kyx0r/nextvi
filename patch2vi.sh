...
compat_order() (
	...
	/^patch2vi\.sh$/			{
		skip = 0
		print "Every line below is one full chain, dependencies included, in an order"
		print "that applies; patches not listed are unconstrained. Regenerated by"
		print "compat_order in patch2vi.sh."
		print ""
