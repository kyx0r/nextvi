...
# Available separators: 0001-0010 0013-0014 0016-0037 0107 0112 0121 0126-0130 0136 0177-0377
...
${SEP}+3c 	int fti = ftidx, blockhl, blockcont = -1, trusted = 0;
	...
	blockhl = syn_blockhl;
${SEP}.,\$;f> 			if \\\\(SYN_SET\\\\(BLK, catt\\\\[i\\\\]\\\\)\\\\) \\\\{
				iatt = &catt\\\\[i \\\\+ inc\\\\];
				inc\\\\+\\\\+;${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL ren.c:369\\${SEP}pr${INTR}${QF}}${SEP}${LB}
${SEP}+3,#+1c 				j = trusted && (SYN_SET(BSDP, *iatt) || !!SYN_SET(BSD, *iatt) == (last_scdir > 0));
				c = trusted && (SYN_SET(BEDP, *iatt) || !!SYN_SET(BED, *iatt) == (last_scdir > 0));
${SEP}.,\$;f> 	fti\\\\+\\\\+;
...
index 9b4776c8..a97eb50d 100644
--- a/ren.c
+++ b/ren.c
...
+
 ...
 {
 	if (fti >= ftmidx)
@@ -310,7 +422,29 @@ int syn_merge(int old, int new)
