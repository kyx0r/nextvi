...
index 0d346df9..23c43aa1 100644
--- a/conf.c
+++ b/conf.c
...
index 0ec68c95..87c1a513 100644
--- a/ex.c
+++ b/ex.c
@@ -1457,6 +1457,16 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
+
 ...
 {
 	int val = atoi(arg);
@@ -1554,6 +1564,7 @@ static struct excmd {
 	{"uc", ec_setenc},
 	{"uz", ec_setenc},
 	{"ub", ec_setenc},
+	{"up", ec_undoleafs},
...
index 7afa37e4..4061d27b 100644
--- a/vi.h
+++ b/vi.h
