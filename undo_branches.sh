...
4??0?
4??+2m 1220reg p OK ex.c:1666:a42sc %? %@2152sc!1q0?
...
grp 08??-13m 1220reg p OK ex.c:1666:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		ex_regesc\(sb, reg\.s, reg\.s \+ reg\.s_n, 1\);
		free\(reg\.s\);
		sbuf_nul\(sb\).*(_EO\(left,)
	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);9??0?
grp 09??-20m 1220reg p OK ex.c:1666:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"uc", ec_setenc},
	\{"uz", ec_setenc},
	\{"ub", ec_setenc},4??0?
4??+2m 2220reg p OK ex.c:1765:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"uc", ec_setenc},.*?
	\{"uz", ec_setenc},.*?
(	\{"ub", ec_setenc},)7??0?
grp 07??m 2220reg p OK ex.c:1765:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"wq", ec_write},
	\{"w!", ec_write},
	\{"w", ec_write},.*(	\{"sc!", ec_specials},)
	\{"sc", ec_specials},
	\{"s", ec_substitute},8??0?
grp 08??-4m 2220reg p OK ex.c:1765:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(rr\),
	\{"r", ec_read},
	\{"wq!", ec_write},.*(	\{"x!", ec_write},)
	\{"x", ec_write},
	\{"ya!", ec_yank},9??0?
grp 09??-7m 2220reg p OK ex.c:1765:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1666:m12sc %? %@2142sc!0?
'\''2i 	{"up", ec_undoleafs},
??!219reg ex.c:1765:m22sc %? %@2142sc!b2m!%ya 98?0?
%f> \{
...
index a2bf8821..3305ee57 100644
--- a/conf.c
+++ b/conf.c
...
index f86fb389..ccf321b4 100644
--- a/ex.c
+++ b/ex.c
@@ -1664,6 +1664,16 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1763,6 +1773,7 @@ static struct excmd {
 	{"uc", ec_setenc},
 	{"uz", ec_setenc},
 	{"ub", ec_setenc},
+	{"up", ec_undoleafs},
...
index e5018fa9..98cd4116 100644
--- a/vi.h
+++ b/vi.h
