...
${SEP}+3${SEP}s/(u\\\\[.*)\\\\]/\\\\1p]/${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL line 306\\${SEP}pr${INTR}${QF}}${SEP}vis 2${SEP}wq" $VI -e 'conf.c'
...
${SEP}.,\$;f> 	\\\\{\"uc\", ec_setenc\\\\},
	\\\\{\"uz\", ec_setenc\\\\},
	\\\\{\"ub\", ec_setenc\\\\},${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL line 1523\\${SEP}pr${INTR}${QF}}${SEP}${LB}
...
index 0a291fa4..b34ca713 100644
--- a/conf.c
+++ b/conf.c
...
+
 ...
 {
 	int val = atoi(arg);
@@ -1521,6 +1531,7 @@ static struct excmd {
 	{"uc", ec_setenc},
 	{"uz", ec_setenc},
 	{"ub", ec_setenc},
+	{"up", ec_undoleafs},
