...
4??0?
4??+2m 1220reg p OK ex.c:812:a42sc %? %@2152sc!1q0?
...
grp 08??-4m 1220reg p OK ex.c:812:a82sc %? %@2152sc!'\''08??1q0?
...
\{
	if \(xpr > 0\) \{9??0?
grp 09??-8m 1220reg p OK ex.c:812:a92sc %? %@2152sc!'\''00?
1;4;8;9??!219reg ex.c:8122sc %? %@2132sc!0?
?0?
%f+ 	\{"rd", ec_undoredo},
	EO\(rr\),
	\{"r", ec_read},
...
%f+ 	\{"rd", ec_undoredo},
	EO\(rr\),
	\{"r", ec_read},4??0?
4??+2m 2220reg p OK ex.c:1762:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"rd", ec_undoredo},.*?
	EO\(rr\),.*?
(	\{"r", ec_read},)7??0?
grp 07??m 2220reg p OK ex.c:1762:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"reg\+", ec_regprint},
	\{"reg", ec_regprint},
	\{"re", ec_krsset},.*(	\{"uz", ec_setenc},)
	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},8??0?
grp 08??-6m 2220reg p OK ex.c:1762:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"m", ec_mark},
	\{"q!", ec_quit},
	\{"q", ec_quit},.*(	EO\(shape\),)
	EO\(seq\),
	\{"sc!", ec_specials},9??0?
grp 09??-9m 2220reg p OK ex.c:1762:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"wq!", ec_write},
	\{"wq", ec_write},4??0?
4??+1m 3220reg p OK ex.c:1764:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"wq!", ec_write},.*?
(	\{"wq", ec_write},)7??0?
grp 07??m 3220reg p OK ex.c:1764:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"reg\+", ec_regprint},
	\{"reg", ec_regprint},
	\{"re", ec_krsset},.*(	\{"uz", ec_setenc},)
	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},8??0?
grp 08??-4m 3220reg p OK ex.c:1764:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"m", ec_mark},
	\{"q!", ec_quit},
	\{"q", ec_quit},.*(	EO\(shape\),)
	EO\(seq\),
	\{"sc!", ec_specials},9??0?
grp 09??-7m 3220reg p OK ex.c:1764:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"sc!", ec_specials},
	\{"sc", ec_specials},
	\{"s", ec_substitute},4??0?
4??+2m 4220reg p OK ex.c:1775:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"sc!", ec_specials},.*?
	\{"sc", ec_specials},.*?
(	\{"s", ec_substitute},)7??0?
grp 07??m 4220reg p OK ex.c:1775:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ud", ec_undoredo},
	EO\(shape\),
	EO\(seq\),.*(	\{"ya\+", ec_yank},)
	\{"ya", ec_yank},
	\{"cm!", ec_cmap},8??0?
grp 08??-4m 4220reg p OK ex.c:1775:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"uc", ec_setenc},
	\{"uz", ec_setenc},
	\{"ub", ec_setenc},.*(	\{"cm", ec_cmap},)
	\{"cd", ec_chdir},
	\{"c", ec_insert},9??0?
grp 09??-7m 4220reg p OK ex.c:1775:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:17752sc %? %@2132sc!0?
...
'\''2i 	{"wqa!", ec_writeall},
	{"wqa", ec_writeall},
??!219reg ex.c:1762:m22sc %? %@2142sc!0?
'\''3i 	{"wa!", ec_writeall},
	{"wa", ec_writeall},
??!219reg ex.c:1764:m32sc %? %@2142sc!0?
'\''4i 	{"xa!", ec_writeall},
	{"xa", ec_writeall},
??!219reg ex.c:1775:m42sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index c92ec213..899a838c 100644
--- a/conf.c
+++ b/conf.c
...
index 58bd7253..46889ad1 100644
--- a/ex.c
+++ b/ex.c
...
+
 ...
 {
 	if (*arg && term_sbuf)
@@ -1760,8 +1783,12 @@ static struct excmd {
 	{"rd", ec_undoredo},
 	EO(rr),
 	{"r", ec_read},
+	{"wqa!", ec_writeall},
...
+	{"wa", ec_writeall},
 	...
 	{"w", ec_write},
 	{"uc", ec_setenc},
@@ -1773,6 +1800,8 @@ static struct excmd {
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
 	{"s", ec_substitute},
+	{"xa!", ec_writeall},
