...
%f+ 	\{"rd", ec_undoredo},
	EO\(rr\),
	\{"r", ec_read},4??0?
4??+2m 2220reg p OK ex.c:1761:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"rd", ec_undoredo},.*?
	EO\(rr\),.*?
(	\{"r", ec_read},)7??0?
grp 07??m 2220reg p OK ex.c:1761:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"reg\+", ec_regprint},
	\{"reg", ec_regprint},
	\{"re", ec_krsset},.*(	\{"uz", ec_setenc},)
	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},8??0?
grp 08??-6m 2220reg p OK ex.c:1761:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"m", ec_mark},
	\{"q!", ec_quit},
	\{"q", ec_quit},.*(	EO\(shape\),)
	EO\(seq\),
	\{"sc!", ec_specials},9??0?
grp 09??-9m 2220reg p OK ex.c:1761:a92sc %? %@2152sc!'\''00?
...
%f+ 	\{"wq!", ec_write},
	\{"wq", ec_write},4??0?
4??+1m 3220reg p OK ex.c:1763:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"wq!", ec_write},.*?
(	\{"wq", ec_write},)7??0?
...
%f+ 	\{"sc!", ec_specials},
	\{"sc", ec_specials},
	\{"s", ec_substitute},4??0?
4??+2m 4220reg p OK ex.c:1774:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"sc!", ec_specials},.*?
	\{"sc", ec_specials},.*?
(	\{"s", ec_substitute},)7??0?
grp 07??m 4220reg p OK ex.c:1774:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ud", ec_undoredo},
	EO\(shape\),
	EO\(seq\),.*(	\{"ya\+", ec_yank},)
	\{"ya", ec_yank},
	\{"cm!", ec_cmap},8??0?
grp 08??-4m 4220reg p OK ex.c:1774:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"uc", ec_setenc},
	\{"uz", ec_setenc},
	\{"ub", ec_setenc},.*(	\{"cm", ec_cmap},)
	\{"cd", ec_chdir},
	\{"c", ec_insert},9??0?
grp 09??-7m 4220reg p OK ex.c:1774:a92sc %? %@2152sc!'\''00?
...
'\''2i 	{"wqa!", ec_writeall},
	{"wqa", ec_writeall},
??!219reg ex.c:1761:m22sc %? %@2142sc!0?
'\''3i 	{"wa!", ec_writeall},
	{"wa", ec_writeall},
??!219reg ex.c:1763:m32sc %? %@2142sc!0?
'\''4i 	{"xa!", ec_writeall},
	{"xa", ec_writeall},
??!219reg ex.c:1774:m42sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index 561030c5..4e1bbe8b 100644
--- a/ex.c
+++ b/ex.c
...
+
 ...
 {
 	if (*arg && term_sbuf)
@@ -1759,8 +1782,12 @@ static struct excmd {
 	{"rd", ec_undoredo},
 	EO(rr),
 	{"r", ec_read},
+	{"wqa!", ec_writeall},
...
+	{"wa", ec_writeall},
 	...
 	{"w", ec_write},
 	{"uc", ec_setenc},
@@ -1772,6 +1799,8 @@ static struct excmd {
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
 	{"s", ec_substitute},
+	{"xa!", ec_writeall},
