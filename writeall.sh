...
3??m 1220reg p OK conf.c:299:a32sc %? %@2152sc!fr 981qfr 980?
%f> \(\?:'\''\[0-9]\+\)\|\(\[\.\$]\|\[0-9 \\t]\*\)\?\)\)\(\?:\(\[-\*-\+/%]\)\[ \\t]\*\(\[0-9]\+\)\[ \\t]\*\)\*\(\?:\[ \\t]\*\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\)\*\[ \\t]\*\)\*\)\\
\(\(pac\|pr\|ai\|ish\|err\|fr\|ic\|grp\|mpt\|rr\|shape\|seq\|ts\|td\|order\|hl\[lwpr]\?\|left\|lim\|led\|vis\)\\
\|\[@&!dmj]\|=\\\\\?\{0,1}\|\\\\\?\{1,2}\[\?!]\?\|b\[psx]\?\|p\[uh]\?\|ac\|e\[f!]\?!\?\|f\[-\+><tdp]\?\|inc\|i\|sc!\?\|\\4??0?
4??+3m 1220reg p OK conf.c:299:a42sc %? %@2152sc!1q0?
...
4??0?
4??+2m 1220reg p OK ex.c:808:a42sc %? %@2152sc!1q0?
...
grp 08??-4m 1220reg p OK ex.c:808:a82sc %? %@2152sc!'\''08??1q0?
...
\{
	if \(xpr > 0\) \{9??0?
grp 09??-8m 1220reg p OK ex.c:808:a92sc %? %@2152sc!'\''00?
1;4;8;9??!219reg ex.c:8082sc %? %@2132sc!0?
?0?
%f+ 	\{"rd", ec_undoredo},
	EO\(rr\),
	\{"r", ec_read},
...
%f+ 	\{"rd", ec_undoredo},
	EO\(rr\),
	\{"r", ec_read},4??0?
4??+2m 2220reg p OK ex.c:1721:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"rd", ec_undoredo},.*?
	EO\(rr\),.*?
(	\{"r", ec_read},)7??0?
grp 07??m 2220reg p OK ex.c:1721:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"reg\+", ec_regprint},
	\{"reg", ec_regprint},
	\{"re", ec_krsset},.*(	\{"uz", ec_setenc},)
	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},8??0?
grp 08??-6m 2220reg p OK ex.c:1721:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"m", ec_mark},
	\{"q!", ec_quit},
	\{"q", ec_quit},.*(	EO\(shape\),)
	EO\(seq\),
	\{"sc!", ec_specials},9??0?
grp 09??-9m 2220reg p OK ex.c:1721:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:17212sc %? %@2132sc!0?
?0?
%f+ 	\{"wq!", ec_write},
	\{"wq", ec_write},
	\{"w!", ec_write},
...
%f+ 	\{"wq!", ec_write},
	\{"wq", ec_write},4??0?
4??+1m 3220reg p OK ex.c:1723:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"wq!", ec_write},.*?
(	\{"wq", ec_write},)7??0?
...
??!219reg ex.c:808:m12sc %? %@2142sc!0?
'\''2i 	{"wqa!", ec_writeall},
	{"wqa", ec_writeall},
??!219reg ex.c:1721:m22sc %? %@2142sc!0?
'\''3i 	{"wa!", ec_writeall},
	{"wa", ec_writeall},
??!219reg ex.c:1723:m32sc %? %@2142sc!0?
'\''4i 	{"xa!", ec_writeall},
	{"xa", ec_writeall},
??!219reg ex.c:1734:m42sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index 1d080daa..7e2b6f1b 100644
--- a/ex.c
+++ b/ex.c
@@ -806,6 +806,29 @@ static void *ec_write(char *loc, char *cmd, char *arg)
 	return NULL;
 }
...
+
 ...
 {
 	if (*arg && term_sbuf)
@@ -1719,8 +1742,12 @@ static struct excmd {
 	{"rd", ec_undoredo},
 	EO(rr),
 	{"r", ec_read},
+	{"wqa!", ec_writeall},
...
+	{"wa", ec_writeall},
 	...
 	{"w", ec_write},
 	{"uc", ec_setenc},
@@ -1732,6 +1759,8 @@ static struct excmd {
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
 	{"s", ec_substitute},
+	{"xa!", ec_writeall},
