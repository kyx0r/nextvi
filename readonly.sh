...
%f+ 	\{"reg", ec_regprint},
	\{"re", ec_krsset},
	\{"rd", ec_undoredo},4??0?
4??+2m 6220reg p OK ex.c:1726:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"reg", ec_regprint},.*?
	\{"re", ec_krsset},.*?
(	\{"rd", ec_undoredo},)7??0?
grp 07??m 6220reg p OK ex.c:1726:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"q!", ec_quit},
	\{"q", ec_quit},
	\{"reg\+", ec_regprint},.*(	\{"wq", ec_write},)
	\{"w!", ec_write},
	\{"w", ec_write},8??0?
grp 08??-4m 6220reg p OK ex.c:1726:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"g", ec_glob},
	EO\(mpt\),
	\{"m", ec_mark},.*(	\{"uc", ec_setenc},)
	\{"uz", ec_setenc},
	\{"ub", ec_setenc},9??0?
grp 09??-7m 6220reg p OK ex.c:1726:a92sc %? %@2152sc!'\''00?
...
'\''6i 	{"ro", ec_readonly},
??!219reg ex.c:1726:m62sc %? %@2142sc!b2m!%ya 98?0?
%f> 				xvis \|= 4;
			else if \(argv\[i]\[j] == '\''a'\''\)
				xvis \|= 8;
			else if \(argv\[i]\[j] == '\''v'\''\)
...
index c10d3ad5..e6302559 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1636,6 +1642,12 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1724,6 +1736,7 @@ static struct excmd {
 	{"reg", ec_regprint},
 	{"re", ec_krsset},
 	{"rd", ec_undoredo},
+	{"ro", ec_readonly},
