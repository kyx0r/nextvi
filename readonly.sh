...
%f+ 	} else if \(ret\)
		return "other buffers modified";
	if \(!strchr\(cmd, '\''!'\''\)\) \{4??0?
4??+2m 4220reg p OK ex.c:779:a42sc %? %@2152sc!1q0?
grp 1%f+ 	} else if \(ret\).*?
		return "other buffers modified";.*?
(	if \(!strchr\(cmd, '\''!'\''\)\) \{)7??0?
...
1;4;7;8;9??!219reg ex.c:7792sc %? %@2132sc!0?
?0?
...
%f> 				xvis \|= 4;
				...
				xvis \|= 8;4??0?
4??+2m 1220reg p OK vi.c:1861:a42sc %? %@2152sc!1q0?
grp 1%f> 				xvis \|= 4;.*?
			else if \(argv\[i]\[j] == '\''a'\''\).*?
(				xvis \|= 8;)7??0?
...
index 92efe600..adb63aae 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1628,6 +1634,12 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
