...
index cc881132..54628309 100644
--- a/conf.c
+++ b/conf.c
...
index f3ea18aa..3ea2d620 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+char readonly = 0;		/* commandline readonly option */
...
@@ -1456,6 +1462,12 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
+
 ...
 {
 	int val = atoi(arg);
@@ -1545,6 +1557,7 @@ static struct excmd {
 	{"reg", ec_regprint},
 	{"re", ec_krsset},
 	{"rd", ec_undoredo},
+	{"ro", ec_readonly},
