...
4??+2m 3220reg p OK ex.c:430:a42sc %? %@2152sc!1q0?
grp 1%f+ 		bufs_switch\(bufs_open\(arg\+cd, len\)\);.*?
		cd = 3; /\* XXX: quick hack to indicate new lbuf \*/.*?
(	})7??0?
grp 07??m 3220reg p OK ex.c:430:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 			bufs\[xbufsmax - 1]\.lb->modified\) \{
		return "last buffer modified";
			...
			fd < 0 \|\| rd \? '\''f'\'' : '\''r'\''\);8??0?
grp 08??-6m 3220reg p OK ex.c:430:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		bufs_switchwft\(fd\)
		return NULL;
	} else if \(xbufcur == xbufsmax && !strchr\(cmd, '\''!'\''\) &&.*(	if \(!\(xvis & 4\)\))
		ex_print\(msg, bar_ft\)
	return \(fd < 0 \|\| rd\) && \*arg \? xuerr : NULL;9??0?
grp 09??-9m 3220reg p OK ex.c:430:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:4302sc %? %@2132sc!0?
?0?
%f+ 	} else if \(ret\)
...
%f+ 	} else if \(ret\)
		return "other buffers modified";
	if \(!strchr\(cmd, '\''!'\''\)\) \{4??0?
4??+2m 4220reg p OK ex.c:783:a42sc %? %@2152sc!1q0?
grp 1%f+ 	} else if \(ret\).*?
		return "other buffers modified";.*?
(	if \(!strchr\(cmd, '\''!'\''\)\) \{)7??0?
grp 07??m 4220reg p OK ex.c:783:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 		free\(ibuf\.s\);
		xquit = quit;
		return ret;.*(			return "write failed: file exists";)
	}
	fd = open\(path, O_WRONLY \| O_CREAT \| O_TRUNC, conf_mode\);8??0?
grp 08??-4m 4220reg p OK ex.c:783:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 			return ret;
	...
	if \(o1 >= 0\) \{9??0?
grp 09??-7m 4220reg p OK ex.c:783:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:7832sc %? %@2132sc!0?
?0?
...
m 01;0grp 1%f> 	\{"q!", ec_quit},
	...
	\{"w!", ec_write},
	\{"w", ec_write},8??0?
grp 08??-4m 6220reg p OK ex.c:1751:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(mpt\),
	\{"m!", ec_mark},
	\{"m", ec_mark},.*(	\{"uc", ec_setenc},)
	\{"uz", ec_setenc},
	\{"ub", ec_setenc},9??0?
grp 09??-7m 6220reg p OK ex.c:1751:a92sc %? %@2152sc!'\''00?
...
'\''3i 	if (access(arg, F_OK) == 0 && access(arg, W_OK) == -1)
		ex_buf->readonly = 1;
??!219reg ex.c:430:m32sc %? %@2142sc!0?
'\''4i 		if (ex_buf->readonly)
			return "write failed: readonly option is set";
??!219reg ex.c:783:m42sc %? %@2142sc!0?
...
'\''6i 	{"ro", ec_readonly},
??!219reg ex.c:1751:m62sc %? %@2142sc!b2m!%ya 98?0?
%f> 				xvis \|= 4;
			else if \(argv\[i]\[j] == '\''a'\''\)
				xvis \|= 8;
			else if \(argv\[i]\[j] == '\''v'\''\)
...
'\''2s/ms/mRs/??!219reg vi.c:1884:m22sc %? %@2142sc!b3m!%ya 98?0?
...
index a2bf8821..0beb5d7a 100644
--- a/conf.c
+++ b/conf.c
...
index f049069e..a8ede358 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -428,6 +430,8 @@ static void *ec_edit(char *loc, char *cmd, char *arg)
...
@@ -781,6 +785,8 @@ static void *ec_write(char *loc, char *cmd, char *arg)
 	} else if (ret)
 		return "other buffers modified";
 	if (!strchr(cmd, '!')) {
+		if (ex_buf->readonly)
...
@@ -1659,6 +1665,12 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1749,6 +1761,7 @@ static struct excmd {
 	{"reg", ec_regprint},
 	{"re", ec_krsset},
 	{"rd", ec_undoredo},
+	{"ro", ec_readonly},
...
index c4d07045..1b3e9d69 100644
--- a/vi.c
+++ b/vi.c
...
index e5018fa9..261f8430 100644
--- a/vi.h
+++ b/vi.h
