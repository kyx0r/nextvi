...
${SEP}+3${SEP}s/\\\\\\\\\$/lw|\\\\\\\\/${SEP}??!${DBG:-re p FAIL line 294\\${SEP}p FAIL line 294${INTR}${QF}}${SEP}vis 2${SEP}wq" $VI -e 'conf.c'
...
${SEP}.,\$;f> 	EO\\\\(left\\\\),
	EO\\\\(lim\\\\),
	EO\\\\(led\\\\),${SEP}??!${DBG:-re p FAIL line 1551\\${SEP}p FAIL line 1551${INTR}${QF}}${SEP}${LB}
