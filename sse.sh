...
\\\\{${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL led.c:6\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 0${SEP}%;f+ 	register const char \\\\*i;
	for \\\\(i=s; \\\\*i && \\\\*i != delim; \\\\+\\\\+i\\\\);
	return i-s;${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL led.c:9\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 1${SEP}${LB}
...
#else
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL led.c:6:m0\\${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a #endif
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL led.c:9:m1\\${SEP}pr${INTR}${QF2}}${SEP}b1${SEP}%ya b${SEP}%;f> 		rstate->holelen = uc_len\\\\(ss\\\\);
		memcpy\\\\(rstate->nullhole, ss, rstate->holelen\\\\);
		memset\\\\(ss, 0, rstate->holelen\\\\);${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ren.c:111\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+3m 0${SEP};0${SEP}0reg${SEP}.,\$f+ ^			ss \\\\+= l;\$${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ren.c:113\\${SEP}pr${INTR}${QF1}}${SEP}98reg${SEP}${LB}
${SEP}m 1${SEP}${LB}
${SEP}'0,#+1c 	} else {
		n = 0;
#ifdef __SSE2__
...
#endif
		for (; (l = uc_len(ss)); n++)
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ren.c:111:m0\\${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a count_done:;
	}
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ren.c:113:m1\\${SEP}pr${INTR}${QF2}}${SEP}b2${SEP}%ya b${SEP}%;f> int uc_slen\\\\(char \\\\*s\\\\)
\\\\{
	int n = 0, l;${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL uc.c:24\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 0${SEP}${LB}
${SEP}'0a #ifdef __SSE2__
	if (utf8_length[0xc0] != 1) {
		__m128i v_mask = _mm_set1_epi8((char)0xc0);
...
#endif
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL uc.c:24:m0\\${SEP}pr${INTR}${QF2}}${SEP}b3${SEP}%ya b${SEP};0${SEP}0reg${SEP}.,\$f> ^#include <ctype\\\\.h>\$${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL vi.c:0\\${SEP}pr${INTR}${QF1}}${SEP}98reg${SEP}${LB}
${SEP}m 0${SEP}${LB}
${SEP}'0i #ifdef __SSE2__
#include <stdint.h>
#include <emmintrin.h>
#endif
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL vi.c:0:m0\\${SEP}pr${INTR}${QF2}}${SEP}vis 2${SEP}b0${SEP}w${SEP}b1${SEP}w${SEP}b2${SEP}w${SEP}b3${SEP}w${SEP}q" $VI -e 'led.c' 'ren.c' 'uc.c' 'vi.c'
