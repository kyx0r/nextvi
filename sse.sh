...
#include <emmintrin.h>
#endif
${SEP}vis 2${SEP}b0${SEP}w${SEP}b1${SEP}w${SEP}b2${SEP}w${SEP}b3${SEP}w${SEP}q" $VI -e 'led.c' 'ren.c' 'uc.c' 'vi.c'

exit 0
=== PATCH2VI DELTA ===
=== PATCH2VI PATCH ===
diff --git a/led.c b/led.c
index 163596e2..4b6cd63b 100644
--- a/led.c
+++ b/led.c
...
index 158a716d..d6b7c5d1 100644
--- a/vi.c
+++ b/vi.c
@@ -1,3 +1,7 @@
+#ifdef __SSE2__
