...
${SEP}??!${DBG:-re p FAIL line 65\\${SEP}p FAIL line 65${INTR}${QF}}${SEP};=
...
${SEP}.,\$;f> 						soff \\\\+ offs\\\\[xgrp\\\\], &xrow, &xoff\\\\)\\\\)
			ret = xuerr;
		free\\\\(sb\\\\.s\\\\);${SEP}??!${DBG:-re p FAIL line 528\\${SEP}p FAIL line 528${INTR}${QF}}${SEP};=
${SEP}+2a 		free(offs);
.
...
${SEP}.,\$;f> 	if \\\\(rs != xkwdrs\\\\)
		rset_free\\\\(rs\\\\);
	free\\\\(rep\\\\);${SEP}??!${DBG:-re p FAIL line 1042\\${SEP}p FAIL line 1042${INTR}${QF}}${SEP};=
${SEP}+2a 	free(offs);
.
...
${SEP}.,\$;f> 				break;
			\\\\*o = _o;
			\\\\*r = i;${SEP}??!${DBG:-re p FAIL line 508\\${SEP}p FAIL line 508${INTR}${QF}}${SEP};=
${SEP}+3c 			if (dir > 0) {
				free(offs);
.
${SEP}.,\$f> 				return 0;${SEP}??!${DBG:-re p FAIL line 509\\${SEP}p FAIL line 509${INTR}${QF}}${SEP};=
${SEP}.a 			}
.
${SEP}.,\$;f> 		\\\\}
		off = 0;
	\\\\}${SEP}??!${DBG:-re p FAIL line 515\\${SEP}p FAIL line 515${INTR}${QF}}${SEP};=
${SEP}+2a 	free(offs);
.
...
EXINIT="|sc! \\\\${SEP}|:vis 3${SEP}%;f> 		xic \\\\? REG_ICASE \\\\| REG_NEWLINE : REG_NEWLINE\\\\);
	if \\\\(!rs\\\\)
		return;${SEP}??!${DBG:-re p FAIL line 48\\${SEP}p FAIL line 48${INTR}${QF}}${SEP};=
${SEP}+3c 	int *subs = emalloc(rs->nsubc * sizeof(int));
.
${SEP}.,\$;f> 	sbuf_null\\\\(acsb\\\\)
	free\\\\(ibuf->s\\\\);
	rset_free\\\\(rs\\\\);${SEP}??!${DBG:-re p FAIL line 80\\${SEP}p FAIL line 80${INTR}${QF}}${SEP};=
${SEP}+2a 	free(subs);
.
${SEP}.,\$;f> 	int att_old = 0, atti = 0, cterm = cend - cbeg;
	char \\\\*bound = NULL;
	char \\\\*\\\\*chrs = r->chrs;	/\\\\* chrs\\\\[i\\\\]: the i-th character in s0 \\\\*/${SEP}??!${DBG:-re p FAIL line 151\\${SEP}p FAIL line 151${INTR}${QF}}${SEP};=
...
${SEP}.,\$;f> 		if \\\\(o >= 0 && r->cmax > cterm && r->pos\\\\[o\\\\] \\\\+ r->wid\\\\[o\\\\] > cend\\\\)
			while \\\\(off\\\\[i\\\\] == o\\\\)
				off\\\\[ctx < 0 \\\\? i\\\\+\\\\+ : i--\\\\] = -1;${SEP}??!${DBG:-re p FAIL line 175\\${SEP}p FAIL line 175${INTR}${QF}}${SEP};=
${SEP}+2a 		stt = emalloc((cterm+1) * sizeof(int));
		ctt = emalloc((cterm+1) * sizeof(int));
.
${SEP}.,\$;f> 		memcpy\\\\(chrs\\\\[n\\\\], r->nullhole, r->holelen\\\\);
		r->holelen = 0;
	\\\\}${SEP}??!${DBG:-re p FAIL line 257\\${SEP}p FAIL line 257${INTR}${QF}}${SEP};=
${SEP}+2a 	free(off);
	free(att);
	free(stt);
	free(ctt);
...
${SEP}.,\$;f> 		return 0;
	flg = prog->flg \\\\| flg;
	const char \\\\*sp = s, \\\\*_sp = s, \\\\*s0, \\\\*s1;${SEP}??!${DBG:-re p FAIL line 628\\${SEP}p FAIL line 628${INTR}${QF}}${SEP};=
...
.
${SEP}.,\$f> 	rsub \\\\*nsub, \\\\*sub, \\\\*matched = NULL, \\\\*freesub = NULL;${SEP}??!${DBG:-re p FAIL line 631\\${SEP}p FAIL line 631${INTR}${QF}}${SEP};=
${SEP}+1c 	rthread *_clist = emalloc(prog->len * sizeof(rthread)), *_nlist = emalloc(prog->len * sizeof(rthread));
.
${SEP}.,\$f> 	rthread \\\\*clist = _clist, \\\\*nlist = _nlist, \\\\*tmp;${SEP}??!${DBG:-re p FAIL line 633\\${SEP}p FAIL line 633${INTR}${QF}}${SEP};=
${SEP}+1${SEP}s/lb\\\\[prog->laidx\\\\+1\\\\]/*lb = emalloc(prog->laidx * sizeof(lb[0]))/${SEP}??!${DBG:-re p FAIL line 633\\${SEP}p FAIL line 633${INTR}${QF}}${SEP}.,\$;f> 	int cnt, spc, i, c, j, osubp = nsubc \\\\* sizeof\\\\(char\\\\*\\\\);
	...
	int eol_ch = flg & REG_NEWLINE \\\\? '\\\\\\\\n' : 0;${SEP}??!${DBG:-re p FAIL line 638\\${SEP}p FAIL line 638${INTR}${QF}}${SEP};=
...
\\\\{${SEP}??!${DBG:-re p FAIL line 717\\${SEP}p FAIL line 717${INTR}${QF}}${SEP};=
${SEP}+3c 	const char **subs = emalloc((rs->nsubc+2) * sizeof(subs[0]));
.
${SEP}.,\$;f> 						grps\\\\[gi \\\\+ 1\\\\] = -1;
					\\\\}
				\\\\}${SEP}??!${DBG:-re p FAIL line 733\\${SEP}p FAIL line 733${INTR}${QF}}${SEP};=
${SEP}+2a 				free(subs);
.
${SEP}.,\$;f> 			\\\\}
		\\\\}
	\\\\}${SEP}??!${DBG:-re p FAIL line 737\\${SEP}p FAIL line 737${INTR}${QF}}${SEP};=
${SEP}+2a 	free(subs);
.
...
\\\\{
	int i = n, set = hls\\\\[i\\\\]\\\\.set;${SEP}??!${DBG:-re p FAIL line 254\\${SEP}p FAIL line 254${INTR}${QF}}${SEP};=
${SEP}+3c 	char **pats = emalloc(hlslen * sizeof(char *));
.
${SEP}.,\$;f> 	ftmap\\\\[fti\\\\]\\\\.ft = name;
	ftmap\\\\[fti\\\\]\\\\.rs = rset_make\\\\(i - n, pats, flg\\\\);
	ftmap\\\\[fti\\\\]\\\\.seteidx = i;${SEP}??!${DBG:-re p FAIL line 260\\${SEP}p FAIL line 260${INTR}${QF}}${SEP};=
${SEP}+2a 	free(pats);
.
${SEP}.,\$;f> 	int fti = ftidx, blockhl = syn_blockhl, blockca = -1;
	re:;
	rset \\\\*rs = ftmap\\\\[fti\\\\]\\\\.rs;${SEP}??!${DBG:-re p FAIL line 310\\${SEP}p FAIL line 310${INTR}${QF}}${SEP};=
${SEP}+3${SEP}s/subs\\\\[rs->nsubc\\\\]/*subs = emalloc(rs->nsubc * sizeof(int))/${SEP}??!${DBG:-re p FAIL line 310\\${SEP}p FAIL line 310${INTR}${QF}}${SEP}.,\$;f> 		flg = REG_NOTBOL;
	\\\\}
	fti\\\\+\\\\+;${SEP}??!${DBG:-re p FAIL line 353\\${SEP}p FAIL line 353${INTR}${QF}}${SEP};=
${SEP}+3c 	if (ftmidx > fti && ftmap[fti-1].ft == ftmap[fti].ft) {
		free(subs);
.
${SEP}.,\$f> 		goto re;${SEP}??!${DBG:-re p FAIL line 354\\${SEP}p FAIL line 354${INTR}${QF}}${SEP};=
${SEP}.a 	}
.
${SEP}.,\$;f> 	if \\\\(blockca >= 0 && SYN_BSSET\\\\(blockca\\\\) && !SYN_BESET\\\\(blockca\\\\) && last_scdir > 0\\\\)
		syn_blockhl = -1;${SEP}??!${DBG:-re p FAIL line 357\\${SEP}p FAIL line 357${INTR}${QF}}${SEP};=
${SEP}+2c 	if (syn_blockhl < 0 || blockhl < 0) {
		free(subs);
.
${SEP}.,\$f> 		return;${SEP}??!${DBG:-re p FAIL line 358\\${SEP}p FAIL line 358${INTR}${QF}}${SEP};=
${SEP}.a 	}
.
${SEP}.,\$;f> 	for \\\\(j = 0; j < n; j\\\\+\\\\+\\\\)
		if \\\\(!att\\\\[j\\\\] \\\\|\\\\| !SYN_BPSET\\\\(blockatt\\\\)\\\\)
			att\\\\[j\\\\] = blockatt;${SEP}??!${DBG:-re p FAIL line 361\\${SEP}p FAIL line 361${INTR}${QF}}${SEP};=
${SEP}+2a 	free(subs);
.
${SEP}.,\$;f> 
void syn_init\\\\(void\\\\)
\\\\{${SEP}??!${DBG:-re p FAIL line 405\\${SEP}p FAIL line 405${INTR}${QF}}${SEP};=
${SEP}+3c 	char **pats = emalloc(ftslen * sizeof(char *));
.
${SEP}.,\$;f> 	for \\\\(; i < ftslen; i\\\\+\\\\+\\\\)
		pats\\\\[i\\\\] = fts\\\\[i\\\\]\\\\.pat;
	syn_ftrs = rset_make\\\\(i, pats, 0\\\\);${SEP}??!${DBG:-re p FAIL line 409\\${SEP}p FAIL line 409${INTR}${QF}}${SEP};=
${SEP}+2a 	free(pats);
.
...
${SEP}.,\$;f> 		restore\\\\(syn_blockhl\\\\)
		restore\\\\(xtd\\\\)
		restore\\\\(ftidx\\\\)${SEP}??!${DBG:-re p FAIL line 167\\${SEP}p FAIL line 167${INTR}${QF}}${SEP};=
${SEP}+2a 		free(tmp);
		free(snum);
.
${SEP}.,\$;f> 				if \\\\(!\\\\(ln = lbuf_get\\\\(xb, xrow\\\\)\\\\)\\\\)
					break;
				ln \\\\+= xoff;${SEP}??!${DBG:-re p FAIL line 1291\\${SEP}p FAIL line 1291${INTR}${QF}}${SEP};=
${SEP}+3c 				char *buf = emalloc(strlen(ln)+4);
.
${SEP}.,\$;f> 				strcpy\\\\(buf, \":e \"\\\\);
				strcpy\\\\(buf\\\\+3, ln\\\\);
				term_push\\\\(buf, strlen\\\\(ln\\\\)\\\\+3\\\\);${SEP}??!${DBG:-re p FAIL line 1294\\${SEP}p FAIL line 1294${INTR}${QF}}${SEP};=
${SEP}+2a 				free(buf);
.
${SEP}.,\$;f> 					goto do_excmd;
				case '/': \\\\{
					cs = vi_curword\\\\(xb, xrow, xoff, vi_arg, 1\\\\);${SEP}??!${DBG:-re p FAIL line 1406\\${SEP}p FAIL line 1406${INTR}${QF}}${SEP};=
${SEP}+3c 					char *buf = emalloc(cs ? strlen(cs)+30 : 30);
.
${SEP}.,\$;f> 						strcat\\\\(buf, cs\\\\);
					free\\\\(cs\\\\);
					ln = vi_enprompt\\\\(\":\", buf, &k, &n\\\\);${SEP}??!${DBG:-re p FAIL line 1411\\${SEP}p FAIL line 1411${INTR}${QF}}${SEP};=
${SEP}+2a 					free(buf);
.
${SEP}.,\$;f> 				case 't': \\\\{
					vi_drawmsg\\\\(\"arg2:\\\\(0\\\\|#\\\\)\"\\\\);
					cs = vi_curword\\\\(xb, xrow, xoff, vi_prefix\\\\(\\\\), 1\\\\);${SEP}??!${DBG:-re p FAIL line 1416\\${SEP}p FAIL line 1416${INTR}${QF}}${SEP};=
${SEP}+3c 					char *buf = emalloc(cs ? strlen(cs)+30 : 30);
.
${SEP}.,\$;f> 						free\\\\(cs\\\\);
					\\\\}
					ln = vi_enprompt\\\\(\":\", buf, &k, &n\\\\);${SEP}??!${DBG:-re p FAIL line 1425\\${SEP}p FAIL line 1425${INTR}${QF}}${SEP};=
${SEP}+2a 					free(buf);
.
${SEP}.,\$;f> 					goto do_excmd; \\\\}
				case 'r': \\\\{
					cs = vi_curword\\\\(xb, xrow, xoff, vi_arg, 1\\\\);${SEP}??!${DBG:-re p FAIL line 1429\\${SEP}p FAIL line 1429${INTR}${QF}}${SEP};=
${SEP}+3c 					char *buf = emalloc(cs ? strlen(cs)+30 : 30);
.
${SEP}.,\$;f> 						free\\\\(cs\\\\);
					\\\\}
					ln = vi_enprompt\\\\(\":\", buf, &k, &n\\\\);${SEP}??!${DBG:-re p FAIL line 1436\\${SEP}p FAIL line 1436${INTR}${QF}}${SEP};=
${SEP}+2a 					free(buf);
.
...
EXINIT="|sc! \\\\${SEP}|:vis 3${SEP}%;f> struct highlight \\\\{
	...
	char \\\\*pat;		/\\\\* regular expression \\\\*/${SEP}??!${DBG:-re p FAIL line 498\\${SEP}p FAIL line 498${INTR}${QF}}${SEP};=
...
index 0d4fb320..9a18055b 100644
--- a/conf.c
+++ b/conf.c
...
index 36b8a6d6..32e6dc09 100644
--- a/ex.c
+++ b/ex.c
...
+		int flg = 0, soff = 0;
 		...
 		int skip = cmd[1] == '+' ? 1 : 0;
 		void *ret = NULL;
@@ -526,6 +527,7 @@ static void *ec_find(char *loc, char *cmd, char *arg)
...
index 628bb946..787a1c1e 100644
--- a/vi.c
+++ b/vi.c
...
+		free(snum);
 	...
 	s = lbuf_get(xb, row);
@@ -1288,10 +1291,11 @@ void vi(int init)
...
@@ -1403,17 +1407,18 @@ void vi(int init)
 					goto do_excmd;
 				case '/': {
...
+					char *buf = emalloc(cs ? strlen(cs)+30 : 30);
 					...
 					strcat(buf1, "s/");
@@ -1423,10 +1428,11 @@ void vi(int init)
 						free(cs);
 					}
 					ln = vi_enprompt(":", buf, &k, &n);
+					free(buf);
...
+					char *buf = emalloc(cs ? strlen(cs)+30 : 30);
 					...
 					if (cs) {
 						strcat(buf, cs);
@@ -1434,6 +1440,7 @@ void vi(int init)
 						free(cs);
 					}
 					ln = vi_enprompt(":", buf, &k, &n);
+					free(buf);
