...
%f+ 	if \(rs != xkwdrs\)
		rset_free\(rs\);
	free\(rep\);4??0?
4??+2m 7220reg p OK ex.c:1267:a42sc %? %@2152sc!1q0?
grp 1%f+ 	if \(rs != xkwdrs\).*?
		rset_free\(rs\);.*?
(	free\(rep\);)7??0?
grp 07??m 7220reg p OK ex.c:1267:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	out:
	free\(fr\);
	free\(r->s\);.*(static void \*ec_exec\(char \*loc, char \*cmd, char \*arg\))
\{
	if \(!\*loc\)8??0?
grp 08??-4m 7220reg p OK ex.c:1267:a82sc %? %@2152sc!'\''08??1q0?
...
grp 09??-7m 7220reg p OK ex.c:1267:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:12672sc %? %@2132sc!0?
...
'\''7i 	free(offs);
??!219reg ex.c:1267:m72sc %? %@2142sc!b2m!%ya 98?0?
...
index 58bd7253..b83a075f 100644
--- a/ex.c
+++ b/ex.c
...
+	int *offs = emalloc(rs->nsubc * sizeof(int));
 	...
 	int b1 = 0, pend, rflg = REG_NEWLINE, hit = 0;
 	sbuf_smake(r, 256)
@@ -1265,6 +1271,7 @@ static void *ec_substitute(char *loc, char *cmd, char *arg)
 	if (rs != xkwdrs)
 		rset_free(rs);
 	free(rep);
+	free(offs);
...
index ac9ccc64..7b897546 100644
--- a/led.c
+++ b/led.c
...
index 8f6f3e14..7c4125d2 100644
--- a/vi.h
+++ b/vi.h
