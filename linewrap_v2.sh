...
b51;0fr 0%f> ^#define exbuf_load\(b\) \\$1008??0?
...
b51;0fr 0%f> ^#define led_crender\(msg, row, col, beg, end\) _led_render\(msg, row, col, beg, end, \\$1012??0?
...
b41;0fr 0%f> ^		xtop = MAX\(0, \*row - curwin->h / 2\);$1070??0?
b41;0fr 0%f> ^	if \(!vi_visual \|\| !s \|\| !vi_vfocused\)$1071??0?
b41;0fr 0%f> ^		else if \(\*row < xtop \|\| \*row >= xtop \+ curwin->h - 1\)$1072??0?
b41;0fr 0%f> ^	if \(l1 > wcols \|\| l1 < 0 \|\| ret \|\| l1 >= rstate->cmax \+ vi_lncol\) \\$1073??0?
...
b41;0fr 0%f> ^/\* draw horizontal separator line at screen row, from x for w columns \*/$1076??0?
b41;0fr 0%f> ^		if \(cmd < 0 && \(\*row < xtop \|\| \*row >= xtop \+ curwin->h\)\)$1077??0?
b41;0fr 0%f> ^static int vi_vfocused = 1;		/\* redrawing the window owning the selection \*/$1078??0?
...
b41;0fr 0%f> ^static int vc_insert\(int cmd\);$1148??0?
b41;0fr 0%f> ^static int vi_visual;			/\* visual mode: 0=off, '\''v'\''=char, '\''V'\''=line '\''b'\''=block \*/$1149??0?
...
b41;0fr 0%f> ^		xtop = MAX\(0, \*row - curwin->h / 2\);$1169??0?
b41;0fr 0%f> ^		char tmp\[wcols\+3], snum\[32];$1170??0?
b41;0fr 0%f> ^	if \(xmpt == 1 && !vi_status && scrrow == xrows - 1\)$1171??0?
b41;0fr 0%f> ^	int scrrow = curwin->y \+ row - xtop;$1172??0?
b41;0fr 0%f> ^	RS\(2, led_prender\(sb->s, r, wx \+ col, 0, wcols - col\)\)$1173??0?
b41;0fr 0%f> ^		else if \(\*row < xtop \|\| \*row >= xtop \+ curwin->h - 1\)$1174??0?
b41;0fr 0%f> ^	if \(col < 0 \|\| col >= wcols\)$1175??0?
b41;0fr 0%f> ^/\* render an lsp diagnostic as virtual text starting at window column col \*/$1176??0?
b41;0fr 0%f> ^		\*row = MIN\(xtop \+ curwin->h - 1 - cnt \+ 1, lbuf_len\(xb\) - 1\);$1177??0?
b41;0fr 0%f> ^		\*row = MIN\(xtop \+ curwin->h / 2, lbuf_len\(xb\) - 1\);$1178??0?
b41;0fr 0%f> ^		if \(cmd < 0 && \(\*row < xtop \|\| \*row >= xtop \+ curwin->h\)\)$1179??0?
...
4??0?
4??+2m 7220reg p OK ex.c:1648:a42sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	return uc_isdigit\(\*arg\) \|\| \(\*arg == '\''-'\'' && uc_isdigit\(arg\[1]\)\) \?
		atoi\(arg\) : \(unsigned char\)\*arg;
}.*(	else if \(\*arg\))
		xleft = atoi\(arg\);
	else if \(lbuf_get\(xb, xrow\)\)8??0?
grp 08??-4m 7220reg p OK ex.c:1648:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	}
	return xkwdrs \? NULL : xserr;
}.*(		xleft = ren_position\(lbuf_get\(xb, xrow\)\)->pos\[MIN\(xoff, rstate->n\)];)
	return NULL;
\)9??0?
grp 09??-7m 7220reg p OK ex.c:1648:a92sc %? %@2152sc!'\''00?
...
%f+ 	EO\(ts\),
	EO\(td\),
	EO\(order\),4??0?
4??+2m 8220reg p OK ex.c:1745:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(ts\),.*?
	EO\(td\),.*?
(	EO\(order\),)7??0?
grp 07??m 8220reg p OK ex.c:1745:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"cd", ec_chdir},
	\{"c", ec_insert},
	\{"j", ec_join},.*(	EO\(hlr\),)
	EO\(hl\),
	EO\(left\),8??0?
grp 08??-4m 8220reg p OK ex.c:1745:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"ya", ec_yank},
	\{"cm!", ec_cmap},
	\{"cm", ec_cmap},.*(	EO\(lim\),)
	EO\(led\),
	EO\(vis\),9??0?
grp 09??-7m 8220reg p OK ex.c:1745:a92sc %? %@2152sc!'\''00?
...
%f+ 	EO\(left\),
	EO\(lim\),
	EO\(led\),4??0?
4??+2m 9220reg p OK ex.c:1753:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(left\),.*?
	EO\(lim\),.*?
(	EO\(led\),)7??0?
grp 07??m 9220reg p OK ex.c:1753:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	EO\(hlp\),
	EO\(hlr\),
	EO\(hl\),.*(/\* parse command argument expanding % and ! \*/)
static const char \*ex_arg\(const char \*src, sbuf \*sb, int \*arg\)
\{8??0?
grp 08??-6m 9220reg p OK ex.c:1753:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(order\),
	EO\(hll\),
	EO\(hlw\),.*(	\*arg = sb->s_n;)
	while \(\*src && \*src != xsep\) \{
		if \(\*src == xexp\) \{9??0?
grp 09??-9m 9220reg p OK ex.c:1753:a92sc %? %@2152sc!'\''00?
...
'\''6s/l\)/lw) EO(hll)/??!219reg ex.c:1643:m62sc %? %@2142sc!0?
'\''7i _EO(lw,
...
??!219reg ex.c:1648:m72sc %? %@2142sc!0?
'\''8i 	EO(hllw),
??!219reg ex.c:1745:m82sc %? %@2142sc!0?
'\''9i 	EO(lw),
??!219reg ex.c:1753:m92sc %? %@2142sc!b2%ya 98?0?
%f> 	return r - s;
}
...
%f> 	curwin->row = xrow;
	curwin->off = xoff;
	curwin->top = xtop;4??0?
4??+2m 1220reg p OK ex.c:2031:a42sc %? %@2152sc!0?
1;4??!219reg ex.c:20312sc %? %@2132sc!0?
?0?
%f+ 	xrow = curwin->row;
	xoff = curwin->off;
	xtop = curwin->top;
...
%f+ 	xrow = curwin->row;
	xoff = curwin->off;
	xtop = curwin->top;4??0?
4??+2m 2220reg p OK ex.c:2047:a42sc %? %@2152sc!0?
1;4??!219reg ex.c:20472sc %? %@2132sc!0?
?0?
%f+ 			exbuf_load\(ex_buf\)
			syn_setft\(xb_ft\);
		}
...
%f+ 		w->row = w->off = w->top = w->left = 0;
	...
	w->next = curwin->next;
	curwin->next = w;2??0?
2??m 3220reg p OK ex.c:2148:a22sc %? %@2152sc!1q0?
;0fr.,$f+ ^		w->row = w->off = w->top = w->left = 0;$3??0?
3??m 3220reg p OK ex.c:2148:a32sc %? %@2152sc!fr 981qfr 980?
%f+ 			exbuf_load\(ex_buf\)
			syn_setft\(xb_ft\);
		}4??0?
4??+3m 3220reg p OK ex.c:2148:a42sc %? %@2152sc!1q0?
%f+ 	}
	w->next = curwin->next;
	curwin->next = w;5??0?
5??-1m 3220reg p OK ex.c:2148:a52sc %? %@2152sc!0?
1;2;3;4;5??!219reg ex.c:21482sc %? %@2132sc!0?
'\''1i 	curwin->topsub = xtopsub;
??!219reg ex.c:2031:m12sc %? %@2142sc!0?
'\''2i 	xtopsub = curwin->topsub;
??!219reg ex.c:2047:m22sc %? %@2142sc!0?
'\''3s/>l/>topsub = w->l/??!219reg ex.c:2148:m32sc %? %@2142sc!b2%ya 98?0?
...
@@ -1640,12 +1646,21 @@ static void *eo_##opt(char *loc, char *cmd, char *arg) { inner }
...
@@ -1743,6 +1758,7 @@ static struct excmd {
 	EO(ts),
 	EO(td),
 	EO(order),
+	EO(hllw),
 	...
 	EO(hlw),
 	EO(hlp),
@@ -1751,6 +1767,7 @@ static struct excmd {
 	EO(left),
 	EO(lim),
 	EO(led),
+	EO(lw),
