...
2??m 2220reg p OK ex.c:1647:a22sc %? %@2152sc!1q0?
;0fr.,$f+ ^EO\(hlp\) EO\(hlr\) EO\(hl\) EO\(lim\) EO\(led\) EO\(vis\)$3??0?
3??m 2220reg p OK ex.c:1647:a32sc %? %@2152sc!fr 981qfr 980?
%f+ 
EO\(pac\) EO\(pr\) EO\(ai\) EO\(err\) EO\(fr\) EO\(ish\) EO\(ic\) EO\(mpt\)
EO\(rr\) EO\(shape\) EO\(seq\) EO\(td\) EO\(order\) EO\(hll\) EO\(hlw\)4??0?
4??+3m 2220reg p OK ex.c:1647:a42sc %? %@2152sc!1q0?
%f+ 
_EO\(ts, xts = \*arg \? eo_val\(arg\) : !xts; xts = MAX\(0, xts\); return NULL;\)
_EO\(grp, xgrp = \(\*arg \? eo_val\(arg\) : !xgrp\) \* 2; xgrp = MAX\(0, xgrp\); return NULL;\)5??0?
5??-1m 2220reg p OK ex.c:1647:a52sc %? %@2152sc!1q0?
%f+ 
..\(........p.....\(.i..E.......E..... .O...h............mpt\)
...rr................... ...............\).....ll...O\(...\)
.O.......O..l........\) ....i......l.d..E......
...
6??+3m 2220reg p OK ex.c:1647:a62sc %? %@2152sc!1q0?
grp 1%f+ .*?
EO\(pac\) EO\(pr\) EO\(ai\) EO\(err\) EO\(fr\) EO\(ish\) EO\(ic\) EO\(mpt\).*?
EO\(rr\) EO\(shape\) EO\(seq\) EO\(td\) EO\(order\) EO\(hll\) EO\(hlw\).*?
...
1;2;3;4;5;6;7;8;9??!219reg ex.c:16472sc %? %@2132sc!0?
?0?
%f+ 	\{"j", ec_join},
	EO\(ts\),
	EO\(td\),
...
grp 1%f+ 	\{"j", ec_join},.*?
	EO\(ts\),.*?
(	EO\(td\),)7??0?
grp 07??m 3220reg p OK ex.c:1747:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"cm", ec_cmap},
	\{"cd", ec_chdir},
	\{"c", ec_insert},.*(	EO\(hlp\),)
	EO\(hlr\),
	EO\(hl\),8??0?
grp 08??-4m 3220reg p OK ex.c:1747:a82sc %? %@2152sc!'\''08??1q0?
...
'\''2s/s\)/s) EO(tc)/??!219reg ex.c:1647:m22sc %? %@2142sc!0?
'\''3i 	EO(tc),
??!219reg ex.c:1747:m32sc %? %@2142sc!b2%ya 98?0?
...
index 6e49f602..aaa2f33a 100644
--- a/ex.c
+++ b/ex.c
...
@@ -1644,7 +1645,7 @@ static void *eo_##opt(char *loc, char *cmd, char *arg) { inner }
...
@@ -1745,6 +1746,7 @@ static struct excmd {
 	{"j", ec_join},
 	EO(ts),
 	EO(td),
+	EO(tc),
