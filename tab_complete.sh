...
1;2;3;4;5;6;7;8;9??!219reg ex.c:16842sc %? %@2132sc!0?
?0?
%f+ 	\{"j", ec_join},
	EO\(ts\),
	EO\(td\),
...
'\''2s/s\)/s) EO(tc)/??!219reg ex.c:1684:m22sc %? %@2142sc!0?
'\''3i 	EO(tc),
...
index 561030c5..5d9a9ff4 100644
--- a/ex.c
+++ b/ex.c
...
@@ -1681,7 +1682,7 @@ static void *eo_##opt(char *loc, char *cmd, char *arg) { inner }
