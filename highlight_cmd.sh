...
/\* lbuf lines are \*always "\\n\\0" terminated, for \$ to work one needs to account for '\''\\n'\'' too \*/
struct highlight hls\[] = \{.*(	\{FT\(c\), "\\\\<\(\?:signed\|unsigned\|char\|short\|int\|\[a-z0-9_]\+_t\|FILE\|DIR\|long\|f\(\?:loat\|64\|32\)\|\\)
double\|void\|enum\|union\|typedef\|static\|extern\|register\|struct\|s\(\?:64\|32\|16\|8\)\|u\(\?:64\|32\|16\|8\)\|b32\|\\
bool\|const\|inline\|restrict\|auto\|\(true\|false\|_\?_\?asm_\?_\?\|mem\(\?:set\|cpy\|cmp\)\|free\|\(\?:posix_\)\?memalign\|\\8??0?
grp 08??-5m 2220reg p OK conf.c:72:a82sc %? %@2152sc'\''08??1q0?
m 01;0grp 1%f> #define MA1	13	/\* bright magenta \*/
#define CY1	14	/\* bright cyan \*/
#define WH1	15	/\* bright white \*/.*(\(\?:m\|c\|v\|aligned_\)alloc\|realloc\(\?:f\|array\)\?\|NULL\|std\(\?:in\|out\|err\)\|errno\)\|\\)
...
grp 07??m 3220reg p OK conf.c:94:a72sc %? %@2152sc1q0?
...
grp 08??-5m 3220reg p OK conf.c:94:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 4220reg p OK conf.c:102:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	\{FT\(c\), NULL, A\(RE1 \| SYN_BGMK\(BL1\)\), 0, 3},
	\{FT\(c\), "\(\\\\\?\)\.\+\?\(:\)", A\(SYN_IGN, YE \| SYN_SATT, 2, NA, CY1,
				YE \| SYN_SATT, 2, NA, CY1\), 5},.*(	\{FT\(tex\), NULL, A\(CY1 \| SYN_BD\), 1, 2},)
	\{FT\(tex\), NULL, A\(RE1\), 0, 1},
	\{FT\(tex\), "\\\\\\\\\[\^\[\{ \\t]\+\(\\\\\[\(\[\^\\\\]]\+\)\\\\]\)\?\(\\\\\{\(\[\^}]\*\)}\)\?",8??0?
grp 08??-6m 4220reg p OK conf.c:102:a82sc %? %@2152sc'\''08??1q0?
m 01;0grp 1%f> 		MA \| SYN_OWR \| SYN_EATT \| SYN_BLK, 1, NA, SYN_BSE \| SYN_BSD\), 1},
	\{FT\(c\), "\^\.\+\\\\\\\\\\n\$", A\(CY1 \| SYN_EATT \| SYN_OATT, 2, NA, BL, 1, NA\), 2},
...
grp 07??m 5220reg p OK conf.c:109:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	\{FT\(roff\), "\\\\\\\\\{1,2}\[\*\$fgkmns]\(\?:\[\^\[\\\\\(]\|\\\\\(\.\.\|\\\\\[\[\^\\\\]]\*\\\\]\)", A\(YE\)},
	\{FT\(roff\), "\\\\\\\\\(\?:\[\^\[\\\\\(\*\$fgkmns]\|\\\\\(\.\.\|\\\\\[\[\^\\\\]]\*\\\\]\)", A\(YE\)},
	\{FT\(roff\), "\\\\\$\[\^\$]\+\\\\\$", A\(YE\)},.*(	\{FT\(mbox\), NULL, A\(CY1 \| SYN_BD\), 1, 2},)
	\{FT\(mbox\), NULL, A\(RE1\), 0, 1},
	\{FT\(mbox\), "\^From \.\*20\.\.\\n\$", A\(CY \| SYN_BD\)},8??0?
grp 08??-6m 5220reg p OK conf.c:109:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 6220reg p OK conf.c:116:a72sc %? %@2152sc1q0?
...
grp 08??-4m 6220reg p OK conf.c:116:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 7220reg p OK conf.c:126:a72sc %? %@2152sc1q0?
...
grp 08??-6m 7220reg p OK conf.c:126:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 8220reg p OK conf.c:133:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	\{FT\(mk\), "\\\\\$\[\\\\\(\{]\[a-zA-Z0-9_]\+\[\\\\\)}]\|\\\\\$\\\\\$", A\(YE\)},
	\{FT\(mk\), "#\.\*", A\(GR \| SYN_IT\)},
	\{FT\(mk\), "\(\[A-Za-z_%\.\\\\-]\+\):", A\(NA, SYN_BD\)},.*(	\{FT\(sh\), "\\"\(\?:\[\^\\"\\\\\\\\]\|\\\\\\\\\.\)\*\\"", A\(BL\)},)
	\{FT\(sh\), "`\(\?:\[\^`\\\\\\\\]\|\\\\\\\\\.\)\*`", A\(BL\)},
	\{FT\(sh\), "'\''\[\^'\'']\*'\''", A\(BL\)},8??0?
grp 08??-4m 8220reg p OK conf.c:133:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 9220reg p OK conf.c:145:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	\{FT\(sh\), "\\\\\$\(\?:\\\\\{\[\^}]\+}\|\[a-zA-Z_0-9]\+\|\[!#\$\?\*@-]\)", A\(RE\)},
	\{FT\(sh\), "\^\(\[a-zA-Z_0-9]\* \*\\\\\(\\\\\)\) \*\\\\\{", A\(NA, SYN_BD\)},
	\{FT\(sh\), "\^\\\\\. \.\*", A\(SYN_BD\)},.*(	\{FT\(py\), "\[a-zA-Z0-9_]\+\(\?=\^\\\\\(\)", A\(SYN_BD\)},)
	\{FT\(py\), "\\"\{3}\.\*\?\\"\{3}", A\(CY\)},
	\{FT\(py\), "\(\?:\(\?:\(\?!\^\\"\\"\\"\)\.\)\*\\"\{3}\\n\$\)\|\(\?:\\"\{3}\(\?:\(\?!\^\\"\\"\\"\)\.\)\*\)\|\\"\{3}",8??0?
grp 08??-4m 9220reg p OK conf.c:145:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 10220reg p OK conf.c:159:a72sc %? %@2152sc1q0?
...
grp 08??-4m 10220reg p OK conf.c:159:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 11220reg p OK conf.c:225:a72sc %? %@2152sc1q0?
...
grp 08??-9m 11220reg p OK conf.c:225:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 12220reg p OK conf.c:228:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	\{FT\(html\), "\^\[\^\{]\*\(\?=\^\\\\\{\)", A\(SYN_SKIP\), 4},
	\{FT\(html\), "\(\?:\^\|\[ \\t\{;]\)\(\[\^\\t -,\.-/:-@\[-\^\{-~]\+:\)\\
\(\?:\[ \\t]\*\(fixed\|absolute\|relative\|\.\+!important\)\|\.\+\?\)\(\?:\(\?=\^;\)\|\(\?=\^}\\n\)\)",.*(	\{FT\(go\), NULL, A\(CY1 \| SYN_BD\), 1, 2},)
	\{FT\(go\), "\(/\\\\\*\(\?:\(\?!\^\\\\\*/\)\.\)\*\)\|\(\(\?:\(\?!\^/\\\\\*\)\.\)\*\\\\\*/\(\?#-1\)\(\?<\\"\.\*\\\\\*/\.\*\\"\)\)",
		A\(BL \| SYN_IT, BL \| SYN_BLK, SYN_BSE \| SYN_BEDP, BL \| SYN_BLK, SYN_BSE \| SYN_BSD\)},8??0?
grp 08??-6m 12220reg p OK conf.c:228:a82sc %? %@2152sc'\''08??1q0?
m 01;0grp 1%f> 	\{FT\(html\), "\(\?:#\\\\<\[A-Fa-f0-9]\+\\\\>\)\|\[-\+]\?\\\\<\(\?:0\[xX]\[0-9a-fA-F]\+\|\[0-9]\+\\
\(\?:\\\\\.\[0-9]\+\)\?\(\?:em\|rem\|px\|pt\|pc\|cm\|mm\|in\|ch\|ex\|vw\|vh\|vmin\|vmax\|dvh\|dvw\|svh\|svw\|lvh\|lvw\|\\
fr\|deg\|rad\|turn\|grad\|ms\|s\|hz\|khz\|dpi\|dpcm\|dppx\|%\|\)\)\\\\>", A\(RE1 \| SYN_ATT, 4, 69, NA, AY1, YE\), 3},.*(	\{FT\(go\), NULL, A\(RE1 \| SYN_BGMK\(BL1\)\), 0, 3},)
	\{FT\(go\), NULL, A\(RE1\), 0, 1},
...
grp 07??m 13220reg p OK conf.c:238:a72sc %? %@2152sc1q0?
...
grp 08??-4m 13220reg p OK conf.c:238:a82sc %? %@2152sc'\''08??1q0?
...
grp 07??m 14220reg p OK conf.c:253:a72sc %? %@2152sc1q0?
...
grp 08??-4m 14220reg p OK conf.c:253:a82sc %? %@2152sc'\''08??1q0?
...
5??-1m 15220reg p OK conf.c:298:a52sc %? %@2152sc1q0?
%f+ .\?...............................\\].......\)\*..\|.\[..t...\*.\?..\?:........\\.......\\.............>\\.\\....\\...\?.\*.....
......-..........\|......t............\*../........................\*.....\\..\*\\\\...........]\|....\.\?...\\\|..\*...t]\*.\*..
...
\(\?..!\?..\).................g.\\.\+\?..d.\|w...........\?.....b.....\?...\[...\?........\?....
	...
	....f.......\\\(.\).....A...\|........ ....,6??0?
6??+3m 15220reg p OK conf.c:298:a62sc %? %@2152sc1q0?
grp 1%f+ \(\?:\(\[,;]#\?\)\[ \\t]\*\(\(\?:\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\(\?:\(\?:<\(\?:\[\^<\\\\\\\\]\|\\\\\\\\\.\?\)\*<\?\|>\(\?:\[\^>\\\\\\\\]\|\\\\\\\\\.\?\)\*>\?\)\|\\.*?
\(\?:'\''\[0-9]\+\)\|\(\[\.\$]\|\[0-9 \\t]\*\)\?\)\)\(\?:\(\[-\*-\+/%]\)\[ \\t]\*\(\[0-9]\+\)\[ \\t]\*\)\*\(\?:\[ \\t]\*\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\)\*\[ \\t]\*\)\*\)\\.*?
\(\(pac\|pr\|ai\|ish\|err\|fr\|ic\|grp\|mpt\|rr\|shape\|seq\|ts\|td\|order\|hl\[lwpr]\?\|left\|lim\|led\|vis\)\\.*?
(\|\[@&!dmj]\|=\\\\\?\{0,1}\|\\\\\?\{1,2}\[\?!]\?\|b\[psx]\?\|p\[uh]\?\|ac\|e\[f!]\?!\?\|f\[-\+><tdp]\?\|inc\|i\|sc!\?\|\\)7??0?
grp 07??m 15220reg p OK conf.c:298:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	\{ex_ft, "\.\+", A\(AY1 \| SYN_BD\), 1},
	\{ex_ft, ":\[ \\t]\*\(\(\(\(\?:\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\(\?:\(\?:<\(\?:\[\^<\\\\\\\\]\|\\\\\\\\\.\?\)\*<\?\|>\(\?:\[\^>\\\\\\\\]\|\\\\\\\\\.\?\)\*>\?\)\|\\
\(\?:'\''\[0-9]\+\)\|\(\[\.%\$]\|\[0-9 \\t]\*\)\?\)\)\(\?:\(\[-\*-\+/%]\)\[ \\t]\*\[0-9]\+\[ \\t]\*\)\*\(\?:\[ \\t]\*\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\)\[ \\t]\*\\.*(	\{vs_ft, "\.\+", A\(AY1 \| SYN_BD\), 1},)
	\{vs_ft, "\(\^\[\?/]\)\|\(\\\\\\\\\[<>]\|\\\\\(\\\\\?\[:=!<>#]\|\\\\\[\\\\\^\?\(\(\?:\\\\\\\\\.\?\|\[\^\\\\]]\)\*\)]\|\\\\\[\|\[\.\^\$\\\\\(\)\*\+\|\?]\|\\\\\{\(\[0-9]\*\(,\)\?\[0-9]\*\)\?}\?\)\|\\\\\\\\\(\.\)",
		A\(SYN_BD, BL1, WH1, GR1, RE1, WH1, YE\)},8??0?
grp 08??-6m 15220reg p OK conf.c:298:a82sc %? %@2152sc'\''08??1q0?
...
'\''3i 	{FT(c), NULL, HI, 0, 4},
??!219reg conf.c:94:m32sc %? %@2142sc0?
'\''4i 	{FT(roff), NULL, HI, 0, 4},
??!219reg conf.c:102:m42sc %? %@2142sc0?
'\''5i 	{FT(tex), NULL, HI, 0, 4},
??!219reg conf.c:109:m52sc %? %@2142sc0?
'\''6i 	{FT(mbox), NULL, HI, 0, 4},
??!219reg conf.c:116:m62sc %? %@2142sc0?
'\''7i 	{FT(mk), NULL, HI, 0, 4},
??!219reg conf.c:126:m72sc %? %@2142sc0?
'\''8i 	{FT(sh), NULL, HI, 0, 4},
??!219reg conf.c:133:m82sc %? %@2142sc0?
'\''9i 	{FT(py), NULL, HI, 0, 4},
??!219reg conf.c:145:m92sc %? %@2142sc0?
'\''10i 	{FT(js), NULL, HI, 0, 4},
??!219reg conf.c:159:m102sc %? %@2142sc0?
'\''11i 	{FT(html), NULL, HI, 0, 4},
??!219reg conf.c:225:m112sc %? %@2142sc0?
'\''12i 	{FT(diff), NULL, HI, 0, 4},
??!219reg conf.c:228:m122sc %? %@2142sc0?
'\''13i 	{FT(go), NULL, HI, 0, 4},
??!219reg conf.c:238:m132sc %? %@2142sc0?
'\''14i 	{FT(md), NULL, HI, 0, 4},
??!219reg conf.c:253:m142sc %? %@2142sc0?
'\''15s/\?\|i/?|hi|i/??!219reg conf.c:298:m152sc %? %@2142scb1%ya 98?0?
%f> 	return NULL;
}
...
3??0?
3??+2m 1220reg p OK ex.c:1230:a32sc %? %@2152sc1q0?
m 01;0grp 1%f> 	}
	for \(i = 1; i < 4; i\+\+\)
		syn_reloadft\(syn_findhl\(i\), 0\);.*(		xkmap_alt = conf_kmapfind\(arg\);)
	else
		ex_print\(conf_kmap\(xkmap\)\[0], msg_ft\)8??0?
grp 08??-4m 1220reg p OK ex.c:1230:a82sc %? %@2152sc'\''08??1q0?
m 01;0grp 1%f> 	if \(led_attsb\) \{
		sbuf_free\(led_attsb\)
		led_attsb = NULL;.*(	if \(arg\[0] && !strchr\(cmd, '\''!'\''\)\))
		xkmap = xkmap_alt;
	return NULL;9??0?
grp 09??-7m 1220reg p OK ex.c:1230:a92sc %? %@2152sc'\''00?
1;3;8;9??!219reg ex.c:12302sc %? %@2132sc0?
?0?
%f+ 	EO\(hlp\),
	EO\(hlr\),
	EO\(hl\),
...
%f+ 	EO\(hlp\),
	EO\(hlr\),
	EO\(hl\),3??0?
3??+2m 2220reg p OK ex.c:1692:a32sc %? %@2152sc1q0?
grp 1%f+ 	EO\(hlp\),.*?
	EO\(hlr\),.*?
(	EO\(hl\),)7??0?
grp 07??m 2220reg p OK ex.c:1692:a72sc %? %@2152sc1q0?
m 01;0grp 1%f> 	EO\(order\),
	EO\(hll\),
	EO\(hlw\),.*(	EO\(vis\),)
	\{"", ec_print}, /\* do not remove \*/
	\{"", ec_print}, /\* do not remove \*/8??0?
grp 08??-4m 2220reg p OK ex.c:1692:a82sc %? %@2152sc'\''08??1q0?
...
\{9??0?
grp 09??-9m 2220reg p OK ex.c:1692:a92sc %? %@2152sc'\''00?
...
??!219reg ex.c:1230:m12sc %? %@2142sc0?
'\''2i 	{"hi", ec_hi},
??!219reg ex.c:1692:m22sc %? %@2142scvis 2b0wb1w2q' > "$P2VIF"
...
+	{_ft, NULL, HI, 0, 4}, /* <-- optional, used by hi if set */
 	...
 	{FT(c), NULL, A(CY1 | SYN_BD), 1, 2},
 	{FT(c), "(/\\*(?:(?!^\\*/).)*)|((?:(?!^/\\*).)*\\*/(?#-1)(?<\".*\\*/.*(?:\"|\\\\\n$)))",
@@ -92,6 +97,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
...
@@ -100,6 +106,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
 	{FT(roff), "^[.'][ \t]*(([sS][hH].*)|(de) (.*)|([^ \t\\\\]{2,}))?.*",
 		A(BL, NA, MA | SYN_BD, BL | SYN_BD, MA | SYN_BD, BL | SYN_BD), 1},
 	{FT(roff), NULL, A(RE1), 0, 1},
+	{FT(roff), NULL, HI, 0, 4},
 	...
 	{FT(roff), "\\\\{1,2}[*$fgkmns](?:[^[\\(]|\\(..|\\[[^\\]]*\\])", A(YE)},
 	{FT(roff), "\\\\(?:[^[\\(*$fgkmns]|\\(..|\\[[^\\]]*\\])", A(YE)},
@@ -107,6 +114,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
...
+	{FT(tex), NULL, HI, 0, 4},
 	{FT(tex), "\\\\[^[{ \t]+(\\[([^\\]]+)\\])?(\\{([^}]*)})?",
 		A(BL | SYN_BD, NA, YE, NA, MA)},
 	{FT(tex), "\\$[^$]+\\$", A(YE)},
@@ -114,6 +122,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
...
+	{FT(mbox), NULL, HI, 0, 4},
 	...
 	{FT(mbox), "^Subject: (.*)", A(CY | SYN_BD, BL | SYN_BD)},
 	{FT(mbox), "^From: (.*)", A(CY | SYN_BD, GR | SYN_BD)},
@@ -124,6 +133,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
...
+	{FT(mk), NULL, HI, 0, 4},
 	...
 	{FT(mk), "\\$[\\({][a-zA-Z0-9_]+[\\)}]|\\$\\$", A(YE)},
 	{FT(mk), "#.*", A(GR | SYN_IT)},
@@ -131,6 +141,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
...
+	{FT(sh), NULL, HI, 0, 4},
 	{FT(sh), "\\<(?:break|case|continue|do|done|elif|else|esac|fi|for|if|in|then|until|while)\\>",
 		A(MA | SYN_BD)},
 	{FT(sh), "[ \t](#.*)|^(#.*)", A(NA, GR | SYN_IT, GR | SYN_IT)},
@@ -143,6 +154,7 @@ bool|const|inline|restrict|auto|(true|false|_?_?asm_?_?|mem(?:set|cpy|cmp)|free|
...
@@ -157,6 +169,7 @@ for|from|global|if|import|in|is|lambda|not|or|pass|print|raise|return|try|while)
 	{FT(js), "(/\\*(?:(?!^\\*/).)*)|((?:(?!^/\\*).)*\\*/(?![\"'`]))",
 		A(GR1 | SYN_IT, GR1 | SYN_BLK, SYN_BSE | SYN_BEDP, GR1 | SYN_BLK, SYN_BSE | SYN_BSD)},
 	{FT(js), NULL, A(RE1), 0, 1},
+	{FT(js), NULL, HI, 0, 4},
...
@@ -223,9 +236,11 @@ fr|deg|rad|turn|grad|ms|s|hz|khz|dpi|dpcm|dppx|%|))\\>", A(RE1 | SYN_ATT, 4, 69,
...
+	{FT(diff), NULL, HI, 0, 4},
 	...
 	{FT(diff), "^\\+.*", A(GR)},
 	{FT(diff), "^@.*", A(CY)},
@@ -236,6 +251,7 @@ fr|deg|rad|turn|grad|ms|s|hz|khz|dpi|dpcm|dppx|%|))\\>", A(RE1 | SYN_ATT, 4, 69,
...
@@ -251,6 +267,7 @@ return|select|switch|type|var))\\>", A(GR1, BL1 | SYN_BD, YE1)},
...
+	{FT(md), NULL, HI, 0, 4},
 	...
 	{FT(md), "^## .*", A(GR | SYN_BD)},
 	{FT(md), "^### .*", A(YE | SYN_BD)},
@@ -295,7 +312,7 @@ return|select|switch|type|var))\\>", A(GR1, BL1 | SYN_BD, YE1)},
 (?:([,;]#?)[ \t]*((?:\\|(?:[^|\\\\]|\\\\.?)*\\|?[ \t]*)*(?:(?:<(?:[^<\\\\]|\\\\.?)*<?|>(?:[^>\\\\]|\\\\.?)*>?)|\
 (?:'[0-9]+)|([.$]|[0-9 \t]*)?))(?:([-*-+/%])[ \t]*([0-9]+)[ \t]*)*(?:[ \t]*\\|(?:[^|\\\\]|\\\\.?)*\\|?)*[ \t]*)*)\
 ((pac|pr|ai|ish|err|fr|ic|grp|mpt|rr|shape|seq|ts|td|order|hl[lwpr]?|left|lim|led|vis)\
-|[@&!dmj]|=\\?{0,1}|\\?{1,2}[?!]?|b[psx]?|p[uh]?|ac|e[f!]?!?|f[-+><tdp]?|inc|i|sc!?|\
...
index 448d1ea5..24d6a9f2 100644
--- a/ex.c
+++ b/ex.c
@@ -1228,6 +1228,70 @@ static void *ec_ft(char *loc, char *cmd, char *arg)
 	return NULL;
 }
...
+
 ...
 {
 	if (arg[0])
@@ -1690,6 +1754,7 @@ static struct excmd {
 	EO(hlp),
 	EO(hlr),
 	EO(hl),
+	{"hi", ec_hi},
