...
%f+ 	EO\(hlp\),
	EO\(hlr\),
	EO\(hl\),3??0?
3??+2m 2220reg p OK ex.c:1681:a32sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(hlp\),.*?
	EO\(hlr\),.*?
(	EO\(hl\),)7??0?
...
grp 08??-4m 2220reg p OK ex.c:1681:a82sc %? %@2152sc!'\''08??1q0?
...
\{9??0?
grp 09??-9m 2220reg p OK ex.c:1681:a92sc %? %@2152sc!'\''00?
...
'\''2i 	{"hi", ec_hi},
??!219reg ex.c:1681:m22sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index 82cd1654..a9cf349c 100644
--- a/ex.c
+++ b/ex.c
...
+
 ...
 {
 	if (arg[0])
@@ -1679,6 +1743,7 @@ static struct excmd {
 	EO(hlp),
 	EO(hlr),
 	EO(hl),
+	{"hi", ec_hi},
