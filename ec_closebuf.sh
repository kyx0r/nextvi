...
${SEP}+3m 0${SEP}${LB}
${SEP}'0s/cd/c[dx]/${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL conf.c:297:m0\\${SEP}pr${INTR}${QF2}}${SEP}b1${SEP}%ya b${SEP}%;f> 	return val;
}

${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1487\\${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}+2m 0${SEP};0${SEP}0reg${SEP}.,\$f+ 	\\\\{\"cd\", ec_chdir\\\\},${SEP}??!${DBG1:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1589\\${SEP}pr${INTR}${QF1}}${SEP}98reg${SEP}${LB}
${SEP}m 1${SEP}${LB}
...
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1487:m0\\${SEP}pr${INTR}${QF2}}${SEP}${LB}
${SEP}'1a 	{\"cx\", ec_closebuf},
${SEP}??!${DBG2:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1589:m1\\${SEP}pr${INTR}${QF2}}${SEP}vis 2${SEP}b0${SEP}w${SEP}b1${SEP}w${SEP}q" $VI -e 'conf.c' 'ex.c'
