...
%f+ 	\{"cm!", ec_cmap},
	\{"cm", ec_cmap},
	\{"cd", ec_chdir},4??0?
4??+2m 2220reg p OK ex.c:1749:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"cm!", ec_cmap},.*?
	\{"cm", ec_cmap},.*?
(	\{"cd", ec_chdir},)7??0?
grp 07??m 2220reg p OK ex.c:1749:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ya!", ec_yank},
	\{"ya\+", ec_yank},
	\{"ya", ec_yank},.*(	EO\(td\),)
	EO\(order\),
	EO\(hll\),8??0?
grp 08??-4m 2220reg p OK ex.c:1749:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"s", ec_substitute},
	\{"x!", ec_write},
	\{"x", ec_write},.*(	EO\(hlw\),)
	EO\(hlp\),
	EO\(hlr\),9??0?
grp 09??-7m 2220reg p OK ex.c:1749:a92sc %? %@2152sc!'\''00?
...
'\''2i 	{"cx", ec_closebuf},
??!219reg ex.c:1749:m22sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index c10d3ad5..09c959a1 100644
--- a/ex.c
+++ b/ex.c
@@ -1636,6 +1636,49 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1747,6 +1790,7 @@ static struct excmd {
 	{"cm!", ec_cmap},
 	{"cm", ec_cmap},
 	{"cd", ec_chdir},
+	{"cx", ec_closebuf},
