...
'\''2i 	{"cx", ec_closebuf},
??!219reg ex.c:1774:m22sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index f049069e..9a4d7037 100644
--- a/ex.c
+++ b/ex.c
@@ -1659,6 +1659,49 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1772,6 +1815,7 @@ static struct excmd {
 	{"cm!", ec_cmap},
 	{"cm", ec_cmap},
 	{"cd", ec_chdir},
+	{"cx", ec_closebuf},
