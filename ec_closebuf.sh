...
m 01;0grp 1%f> 	\{"s", ec_substitute},
	...
	EO\(hlp\),
	EO\(hlr\),9??0?
grp 09??-7m 2220reg p OK ex.c:1759:a92sc %? %@2152sc!'\''00?
...
index bf37a9ce..c58bbb24 100644
--- a/conf.c
+++ b/conf.c
...
index 4efc8c2e..f1b5f22d 100644
--- a/ex.c
+++ b/ex.c
@@ -1645,6 +1645,49 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1757,6 +1800,7 @@ static struct excmd {
 	{"cm!", ec_cmap},
 	{"cm", ec_cmap},
 	{"cd", ec_chdir},
+	{"cx", ec_closebuf},
