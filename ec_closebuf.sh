...
${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1453\\${SEP}pr${INTR}${QF}}${SEP}${LB}
...
${SEP}.,\$f> 	\\\\{\"cd\", ec_chdir\\\\},${SEP}??!${DBG:-ya!p\\${SEP}prp\\${SEP}p FAIL ex.c:1555\\${SEP}pr${INTR}${QF}}${SEP}${LB}
...
index 21b22191..69ac72ae 100644
--- a/conf.c
+++ b/conf.c
...
index 50b89bc6..fa44cddb 100644
--- a/ex.c
+++ b/ex.c
@@ -1451,6 +1451,49 @@ static int eo_val(char *arg)
 	return val;
 }
...
@@ -1553,6 +1596,7 @@ static struct excmd {
 	{"cm!", ec_cmap},
 	{"cm", ec_cmap},
 	{"cd", ec_chdir},
+	{"cx", ec_closebuf},
