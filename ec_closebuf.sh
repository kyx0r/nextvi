...
%f+ 	\{"cm!", ec_cmap},
	\{"cm", ec_cmap},
	\{"cd", ec_chdir},4??0?
4??+2m 2220reg p OK ex.c:1779:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"cm!", ec_cmap},.*?
	\{"cm", ec_cmap},.*?
(	\{"cd", ec_chdir},)7??0?
grp 07??m 2220reg p OK ex.c:1779:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ya!", ec_yank},
	\{"ya\+", ec_yank},
	\{"ya", ec_yank},.*(	EO\(td\),)
	EO\(order\),
	EO\(hll\),8??0?
grp 08??-4m 2220reg p OK ex.c:1779:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"s", ec_substitute},
	\{"x!", ec_write},
	\{"x", ec_write},.*(	EO\(hlw\),)
	EO\(hlp\),
	EO\(hlr\),9??0?
grp 09??-7m 2220reg p OK ex.c:1779:a92sc %? %@2152sc!'\''00?
...
'\''2i 	{"cx", ec_closebuf},
??!219reg ex.c:1779:m22sc %? %@2142sc!vis 2b0wb1w2q' > "$P2VIF"
...
index a2bf8821..87152d7a 100644
--- a/conf.c
+++ b/conf.c
...
index 4169d06f..8bd3e321 100644
--- a/ex.c
+++ b/ex.c
@@ -1664,6 +1664,49 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
