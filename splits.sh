...
# Available separators: 0003-0010 0013-0014 0016-0037 0112 0132 0177-0377
...
'err 0b61;0fr 0%f> ^/\* lsp\.c - Language Server Protocol client for nextvi \*/$1000??0?
b41;0fr 0%f> ^/\* render an lsp diagnostic as virtual text starting at screen column col \*/$1001??0?
b61;0fr 0%f> ^#include "jsmn\.h"$1002??0?
b41;0fr 0%f> ^	const char \*diag = NULL;$1003??0?
b61;0fr 0%f> ^#include <errno\.h>$1004??0?
b41;0fr 0%f> ^	if \(s && xb_path && xb_path\[0]\)$1005??0?
b61;0fr 0%f> ^#define LSP_DIAG_MAX	64$1006??0?
b41;0fr 0%f> ^		int dcol = l1 \+ rstate->cmax - xleft;$1007??0?
b61;0fr 0%f> ^#define LSP_SRV_MAX	8$1008??0?
b41;0fr 0%f> ^		if \(diag\)$1009??0?
b61;0fr 0%f> ^#define LSP_RBUF_MAX	65536$1010??0?
b41;0fr 0%f> ^	int dcol = rstate->cmax - xleft;$1011??0?
b61;0fr 0%f> ^#define LSP_DOCS_MAX	16$1012??0?
b41;0fr 0%f> ^	if \(diag\)$1013??0?
b61;0fr 0%f> ^#define LSP_FILES_MAX	\(LSP_SRV_MAX \* 4\)$1014??0?
b41;0fr 0%f> ^void lsp_show_msg\(char \*msg\) \{ vi_drawmsg_mpt\(msg\) }$1015??0?
b61;0fr 0%f> ^#define LSP_PATH_MAX	1024$1016??0?
