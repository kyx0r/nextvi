...
\\\\(\\\\[0-9\\\\]\\\\*\\\\)\\\\?\\\\)\\\\(\\\\?:\\\\(\\\\[-\\\\*-\\\\+/%\\\\]\\\\)\\\\(\\\\[0-9\\\\]\\\\+\\\\)\\\\)\\\\*\\\\(\\\\?:\\\\\\\\\\\\\\\\\\\\|\\\\.\\\\*\\\\?\\\\(\\\\?:\\\\(\\\\?<\\\\^\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\)\\\\\\\\\\\\\\\\\\\\|\\\\|\\\\\$\\\\)\\\\)\\\\*\\\\[ \\\\\\\\t\\\\]\\\\*\\\\)\\\\*\\\\)\\\\\\\\
\\\\(\\\\(pac\\\\|pr\\\\|ai\\\\|ish\\\\|err\\\\|ic\\\\|grp\\\\|mpt\\\\|rcm\\\\|shape\\\\|seq\\\\|ts\\\\|td\\\\|order\\\\|hl\\\\[lwpr\\\\]\\\\?\\\\|left\\\\|lim\\\\|led\\\\|vis\\\\)\\\\\\\\${SEP}??!.-5,.+5p\\${SEP}p FAIL line 261\\${SEP}vis 4\\${SEP}q!${SEP};=
...
struct buf \\\\*ex_pbuf;		/\\\\* prev buffer \\\\*/${SEP}??!.-5,.+5p\\${SEP}p FAIL line 44\\${SEP}vis 4\\${SEP}q!${SEP};=
...
${SEP}.,$;f+ 		ex_buf = &bufs\\\\[idx\\\\];
	\\\\}
	exbuf_load\\\\(ex_buf\\\\)${SEP}??!.-5,.+5p\\${SEP}p FAIL line 100\\${SEP}vis 4\\${SEP}q!${SEP};=
...
${SEP}.,$;f+ 	\\\\}
	exbuf_load\\\\(ex_buf\\\\)
	syn_setft\\\\(xb_ft\\\\);${SEP}??!.-5,.+5p\\${SEP}p FAIL line 161\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a 	/* update current window's buffer reference */
	if (curwin)
		curwin->buf = ex_buf;
.
...
\\\\{${SEP}??!.-5,.+5p\\${SEP}p FAIL line 95\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a 	int ww = curwin ? curwin->w : xcols;
.
${SEP}.-1${SEP}>	if \\(dir_context\\(s\\) < 0\\)>+1;17;22c ww
.
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 97\\${SEP}vis 4\\${SEP}q!${SEP}.,$;f+ 		return;
	\\\\}
	int dir, off, pos, psn = sb->s_n;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 289\\${SEP}vis 4\\${SEP}q!${SEP};=
...
${SEP}.,$;f+ 			pos = ren_cursor\\\\(r->s, r->pos\\\\[off-two\\\\]\\\\);
		pos \\\\+= dir < 0 \\\\? -1 : 1;
	\\\\}${SEP}??!.-5,.+5p\\${SEP}p FAIL line 308\\${SEP}vis 4\\${SEP}q!${SEP};=
...
.
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 311\\${SEP}vis 4\\${SEP}q!${SEP}.,$;f+ if \\\\(ai_max >= 0\\\\) \\\\\\\\
	term_pos\\\\(crow - ctop, 0\\\\); \\\\\\\\
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 363\\${SEP}vis 4\\${SEP}q!${SEP};=
...
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 368\\${SEP}vis 4\\${SEP}q!${SEP}.,$;f+ 			sbuf_mem\\\\(cb, cs, nl\\\\+!!cs\\\\[nl\\\\]\\\\)
			sbufn_null\\\\(cb\\\\)
			rstate->s = NULL;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 377\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;25;55c winx + vi_lncol, xleft, xleft + winw
.
${SEP}.,$;f+ 		\\\\}
		nl = r < crow-ctop \\\\? r\\\\+ctop : \\\\(r-\\\\(crow-orow\\\\+!!\\\\(flg & 4\\\\)\\\\)\\\\)\\\\+ctop;
		led_crender\\\\(lbuf_get\\\\(xb, nl\\\\) \\\\? lbuf_get\\\\(xb, nl\\\\) : \"~\", r,${SEP}??!.-5,.+5p\\${SEP}p FAIL line 384\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3c 			winx + vi_lncol, xleft, xleft + winw - vi_lncol)
.
${SEP}.-1${SEP}>	\\}>+1;23;24c winx
.
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 386\\${SEP}vis 4\\${SEP}q!${SEP}.,$;f+ 		case TK_CTL\\\\('z'\\\\):
			term_suspend\\\\(\\\\);
...
${SEP}.,$;f+ 			else
				restore\\\\(ex_buf\\\\)
			exbuf_load\\\\(ex_buf\\\\)${SEP}??!.-5,.+5p\\${SEP}p FAIL line 588\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a 			if (curwin)
				curwin->buf = ex_buf;
.
${SEP}.,$;f+ 			term_done\\\\(\\\\);
			term_init\\\\(\\\\);
			if \\\\(ai_max >= 0\\\\)${SEP}??!.-5,.+5p\\${SEP}p FAIL line 611\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;46c , ai_max
.
...
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 104\\${SEP}vis 4\\${SEP}q!${SEP};=
...
${SEP}.,$;f+ noff = xoff; \\\\\\\\
for \\\\(i = 0, ret = 0;; i\\\\+\\\\+\\\\) \\\\{ \\\\\\\\
	l1 = ren_next\\\\(c, ren_pos\\\\(c, noff\\\\), 1\\\\)-1-xleft\\\\+vi_lncol; \\\\\\\\${SEP}??!.-5,.+5p\\${SEP}p FAIL line 120\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;10;11c w
.
${SEP}.,$;f+ 	ret = func; \\\\\\\\
\\\\} \\\\} \\\\\\\\
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 127\\${SEP}vis 4\\${SEP}q!${SEP};=
...
\\\\{
	int l1, i, i1, lnnum = vi_lnnum;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 130\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a 	int wrows = win_height();
	int wcols = win_width();
	int scrrow = win_scrrow(row);
.
${SEP}.,$;f+ 	char \\\\*c, \\\\*s;
	static char ch\\\\[5\\\\] = \"~\";${SEP}??!.-5,.+5p\\${SEP}p FAIL line 133\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2;18;31c scrrow ==
.
${SEP}.,$;f+ 		int noff, nrow, ret;
		s = lbuf_get\\\\(xb, row - vi_rshift\\\\);
		c = lbuf_get\\\\(xb, xrow\\\\);${SEP}??!.-5,.+5p\\${SEP}p FAIL line 139\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;20;21c w
.
${SEP}.,$;f+ 			vi_rshift = 0;
		if \\\\(row != xrow\\\\+1 \\\\|\\\\| !c \\\\|\\\\| \\\\*c == '\\\\\\\\n'\\\\)
			goto skip;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 143\\${SEP}vis 4\\${SEP}q!${SEP};=
...
\\\\{
	int n;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 230\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3c 	int wrows = win_height();
	term_pos(curwin ? curwin->y : 0, 0);
.
${SEP}.,$;f+ 	term_room\\\\(i\\\\);
	syn_scdir\\\\(i\\\\);
	if \\\\(i < 0\\\\) \\\\{${SEP}??!.-5,.+5p\\${SEP}p FAIL line 234\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;14;15c w
.
${SEP}.-1${SEP}>		for \\(i = 0; i < n; i\\+\\+\\)>+1;21;22c w
.
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 236\\${SEP}vis 4\\${SEP}q!${SEP}.-1${SEP}>	\\} else \\{>+1;13;14c w
.
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 238\\${SEP}vis 4\\${SEP}q!${SEP}.,$;f+ 		\\\\*row = MIN\\\\(xtop \\\\+ cnt - 1, lbuf_len\\\\(xb\\\\) - 1\\\\);
		break;
	case 'L':${SEP}??!.-5,.+5p\\${SEP}p FAIL line 371\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;20;25c win_height()
.
${SEP}.,$;f+ 		break;
	case 'M':${SEP}??!.-5,.+5p\\${SEP}p FAIL line 374\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2;20;25c win_height()
.
${SEP}.,$;f+ 			ex_bufpostfix\\\\(&bufs\\\\[i\\\\], 1\\\\);
		syn_setft\\\\(xb_ft\\\\);
		vc_status\\\\(0\\\\);${SEP}??!.-5,.+5p\\${SEP}p FAIL line 753\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;23;28c win_height()
.
${SEP}.,$;f+ 	case 'N':
		if \\\\(vi_search\\\\(mv, cnt, row, off, 1\\\\)\\\\)
			return -1;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 786\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;23;28c win_height()
.
${SEP}.,$;f+ 		\\\\}
		if \\\\(vi_search\\\\(cadir < 0 \\\\? 'N' : 'n', 1, row, off, 1\\\\)\\\\)
			cadir = -cadir;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 799\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3,#+1c 		else if (*row < xtop || *row >= xtop + win_height() - 1)
			xtop = MAX(0, *row - win_height() / 2);
.
${SEP}.,$;f+ 		xoff = lbuf_eol\\\\(xb, xrow, 1\\\\);
	else if \\\\(cmd == 'o'\\\\) \\\\{
		xrow\\\\+\\\\+;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1031\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;21;26c win_height()
.
${SEP}.,$;f+ static void vi_scrollbackward\\\\(int cnt\\\\)
\\\\{
	xtop = MAX\\\\(0, xtop - cnt\\\\);${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1117\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;25;30c win_height()
.
${SEP}.,$;f+ \\\\}

#define topfix\\\\(\\\\) \\\\\\\\${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1180\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a { int _wh = win_height(); \\\\
.
${SEP}.,$;f+ if \\\\(xrow < 0 \\\\|\\\\| xrow >= lbuf_len\\\\(xb\\\\)\\\\) \\\\\\\\
	xrow = lbuf_len\\\\(xb\\\\) \\\\? lbuf_len\\\\(xb\\\\) - 1 : 0; \\\\\\\\
if \\\\(xtop > xrow\\\\) \\\\\\\\${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1184\\${SEP}vis 4\\${SEP}q!${SEP};=
...
${SEP}.,$;f+ 	int mv, n, k, c;
	xgrec\\\\+\\\\+;
	if \\\\(init\\\\) \\\\{${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1195\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a 		win_init();
.
${SEP}.,$;f+ 		topfix\\\\(\\\\)
		vi_col = vi_off2col\\\\(xb, xrow, xoff\\\\);${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1198\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2,#+1c 		if (nwins > 1) {
			if (curwin) {
				curwin->row = xrow;
				curwin->off = xoff;
...
${SEP}.,$;f+ 			c = term_read\\\\(TK_CTL\\\\('l'\\\\)\\\\);
			switch \\\\(c\\\\) \\\\{
			case TK_CTL\\\\('b'\\\\):${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1246\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;40;45c win_height()
.
${SEP}.,$;f+ 				vi_mod \\\\|= 4;
				break;
			case TK_CTL\\\\('f'\\\\):${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1251\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;39;44c win_height()
.
${SEP}.,$;f+ 					break;
				if \\\\(vi_arg\\\\)
					vi_scrollud = vi_arg;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1270\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;36;41c win_height()
.
${SEP}.,$;f+ 					break;
				if \\\\(vi_arg\\\\)
					vi_scrollud = vi_arg;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1282\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+3;36;41c win_height()
.
${SEP}.-1${SEP}>				xrow = MIN\\(MAX\\(0, lbuf_len\\(xb\\) - 1\\), xrow \\+ n\\);>+1,#+1c 				if (xtop < lbuf_len(xb) - win_height())
					xtop = MIN(lbuf_len(xb) - win_height(), xtop + n);
.
${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1284\\${SEP}vis 4\\${SEP}q!${SEP}.,$;f+ 				case 'v':
					term_push\\\\(k == 'v' \\\\? \":\\\\\\\\x01\" : \":\\\\\\\\x02\", 2\\\\); /\\\\* \\\\^a : \\\\^b \\\\*/
					break;${SEP}??!.-5,.+5p\\${SEP}p FAIL line 1402\\${SEP}vis 4\\${SEP}q!${SEP};=
${SEP}.+2a 				case 'c':
