...
%f> 	rset \*rs = rset_smake\(pat, 0\);
	...
	free\(pat\);
	if \(!rs\)2??0?
2??m 1220reg p OK vi.c:721:a22sc %? %@2152sc!1q0?
;0fr.,$f> ^	rset \*rs = rset_smake\(pat, 0\);$3??0?
3??m 1220reg p OK vi.c:721:a32sc %? %@2152sc!fr 981qfr 980?
%f> \{
	char \*pat = xref_pat\(sym\), \*path;
	struct lbuf \*ls = tempbufs\[1]\.lb;4??0?
4??+3m 1220reg p OK vi.c:721:a42sc %? %@2152sc!1q0?
%f> 	int i, n = lbuf_len\(ls\), len, row, off, beg = 0, ret = 0, bs;
	free\(pat\);
	if \(!rs\)5??0?
5??-1m 1220reg p OK vi.c:721:a52sc %? %@2152sc!0?
1;2;3;4;5??!219reg vi.c:721:r2332sc %? %@2132sc!0?
?0?
%f+ 		path\[len] = '\''\\n'\'';
	}
	restore\(xgrp\)
...
%f+ 	rset_free\(rs\);
	if \(ret\)
		\*outline = row;
	return ret;2??0?
2??m 2220reg p OK vi.c:762:a22sc %? %@2152sc!1q0?
;0fr.,$f+ ^	rset_free\(rs\);$3??0?
3??m 2220reg p OK vi.c:762:a32sc %? %@2152sc!fr 981qfr 980?
%f+ 		path\[len] = '\''\\n'\'';
	}
	restore\(xgrp\)4??0?
4??+3m 2220reg p OK vi.c:762:a42sc %? %@2152sc!1q0?
%f+ 	if \(ret\)
		\*outline = row;
	return ret;5??0?
5??-1m 2220reg p OK vi.c:762:a52sc %? %@2152sc!0?
1;2;3;4;5??!219reg vi.c:762:r2332sc %? %@2132sc!0?
?'\''1s/et \*rs = rset_s/tr *rs = rstr_/1??1??1q'\''1s/et( \*.* rs)et_s/tr\1tr_/2??2??'\''1220reg p OK vi.c:721:s22sc %? %@2162sc!0?
1;2??!219reg vi.c:721:r233:m12sc %? %@2142sc!0?
'\''2s/et/tr/??!219reg vi.c:762:r233:m22sc %? %@2142sc!p compat 233 applied: src=rstr.sh' > "$P2VIF".233
...
index f0ce0805..d6b13dab 100644
--- a/ex.c
+++ b/ex.c
...
index 09100cde..a1e57908 100644
--- a/vi.c
+++ b/vi.c
