...
'b01;0fr 0%f> ^struct buf tempbufs\[4];		/\* temporary buffers, for internal use \*/$1000??0?
b11;0fr 0%f> ^	temp_open\(3, "/grep/", grep_ft\);$1001??0?
b21;0fr 0%f> ^extern struct buf tempbufs\[4];$1002??0?
b11;0fr 0%f> ^				case '\''x'\'':$1003??0?
b11;0fr 0%f> ^				memcpy\(buf\+3, ln, n \+ 1\);$1004??0?
b11;0fr 0%f> ^		} else if \(mv == TK_CTL\('\''x'\''\)\) \{$1005??0?
b11;0fr 0%f> ^			fs_search\(0, 1, row, off\);$1006??0?
b11;0fr 0%f> ^	case TK_CTL\('\''x'\''\):$1007??0?
b11;0fr 0%f> ^		fssearch\(ret && xrow\)$1008??0?
b11;0fr 0%f> ^		fssearch\(ret && xrow && again != 2\)$1009??0?
b11;0fr 0%f> ^static int fs_search\(int again, int cnt, int \*row, int \*off\)$1010??0?
b11;0fr 0%f> ^if \(isbuffer\) \{ \\$1011??0?
b11;0fr 0%f> ^#define fssearch\(isbuffer\) \\$1012??0?
b11;0fr 0%f> ^					temp_switch\(3, 1\);$1013??0?
b11;0fr 0%f> ^					vi_mod = 1;$1014??0?
b11;0fr 0%f> ^				if \(!strcmp\(xb_path, "/grep/"\)\) \{$1015??0?
b11;0fr 0%f> ^					int subs\[2];$1016??0?
b11;0fr 0%f> ^					rset \*rs = rset_make\(1, \(char\*\[]\)\{":\[0-9]\+:"}, 0\);$1017??0?
b11;0fr 0%f> ^					if \(rset_find\(rs, buf, subs, 0\) >= 0\) \{$1018??0?
b11;0fr 0%f> ^						buf\[subs\[0]] = xsep;$1019??0?
230reg 0231reg 01000,1001,1002,1003,1004;1005,1006,1007,1008,1009;1010,1011,1012,1013,1014;1015,1016,1017,1018,1019?? 231reg 11000,1001,1002,1003,1004;1005,1006,1007,1008,1009;1010,1011,1012,1013,1014;1015,1016,1017,1018,1019?? 230reg+ 1b11;0fr 0%f> ^		if \(xrow - xtop == curwin->h\)$1020??0?
b11;0fr 0%f> ^	term_pos\(curwin->y \+ row - xtop, curwin->x\);$1021??0?
b11;0fr 0%f> ^	xrow = MIN\(xrow, xtop \+ curwin->h - 1\);$1022??0?
b11;0fr 0%f> ^else if \(xrow >= xtop \+ curwin->h\) \\$1023??0?
b11;0fr 0%f> ^		vi_redraw\(\);$1024??0?
b11;0fr 0%f> ^			vi_drawrow\(otop \+ curwin->h - 1\);$1025??0?
b11;0fr 0%f> ^				vi_scrollbackward\(MAX\(1, vi_arg\) \* \(curwin->h - 1\)\);$1026??0?
b11;0fr 0%f> ^				vi_scrollforward\(MAX\(1, vi_arg\) \* \(curwin->h - 1\)\);$1027??0?
b11;0fr 0%f> ^				if \(xtop < lbuf_len\(xb\) - curwin->h\)$1028??0?
b11;0fr 0%f> ^					n = xrows;$1029??0?
b11;0fr 0%f> ^					win_size\(n, xcols\);$1030??0?
b11;0fr 0%f> ^				case '\''c'\'':$1031??0?
b11;0fr 0%f> ^							xrow >= xtop \+ curwin->h - !vi_status\)\)$1032??0?
b11;0fr 0%f> ^			case TK_CTL\('\''l'\''\): \{$1033??0?
b11;0fr 0%f> ^				if \(xrows != orows \+ !!vi_status \|\| xcols != ocols\)$1034??0?
b11;0fr 0%f> ^					xtop = MAX\(0, xrow - curwin->h \+ 1\);$1035??0?
b11;0fr 0%f> ^				term_pos\(curwin->y \+ xrow - xtop, curwin->x\);$1036??0?
b11;0fr 0%f> ^		if \(vi_col >= xleft \+ curwin->w \|\| vi_col < xleft\)$1037??0?
b11;0fr 0%f> ^		if \(vi_mod & 1\)$1038??0?
b11;0fr 0%f> ^				&& xrow\+1 < xtop \+ curwin->h\)$1039??0?
232reg 01020,1021,1022,1023,1024;1025,1026,1027,1028,1029;1030,1031,1032,1033,1034;1035,1036,1037,1038,1039?? 232reg 11020,1021,1022,1023,1024;1025,1026,1027,1028,1029;1030,1031,1032,1033,1034;1035,1036,1037,1038,1039?? 230reg+ 1211reg fr 230f> 1??!? %@221fr 98b01b11b210?
b3%ya 972sc %? %@972sc!b01b11b21fr 232f> 110??10??211reg10??!211reg ? %@2210?
b4%ya 502sc %1000,1001,1002,1003,1004;1005,1006,1007,1008,1009;1010,1011,1012,1013,1014;1015,1016,1017,1018,1019?? %@502sc!b11211reg ? %@2210?
b5%ya 512sc %1020,1021,1022,1023,1024;1025,1026,1027,1028,1029;1030,1031,1032,1033,1034;1035,1036,1037,1038,1039?? %@512sc!vis 2b0wb1wb2w2q' > "$P2VIF".d
...
%f> 				if \(!strcmp\(xb_path, "/xref/"\)\) \{
				...
				term_push\(buf, strlen\(buf\)\);
					...
					if \(rset_find\(rs, buf, subs, 0\) >= 0\) \{
						buf\[subs\[0]] = xsep;
						buf\[subs\[1]-1] = '\''\\n'\'';2??0?
2??m 1220reg p OK vi.c:1774:a22sc %? %@2152sc!1q0?
%f> 				if \(!strcmp\(xb_path, "/xref/"\)\) \{
					int subs\[2];	/\* an xref header opens at its line \*/
					rset \*rs = rset_smake\(":\[0-9]\+\\n", 0\);
					if \(rset_find\(rs, buf, subs, 0\) >= 0\) \{
...
3??m 1220reg p OK vi.c:1774:a32sc %? %@2152sc!1q0?
%f> 				char buf\[n \+ 4];
				memcpy\(buf, ":e ", 3\);
				memcpy\(buf\+3, ln, n \+ 1\);4??0?
4??+3m 1220reg p OK vi.c:1774:a42sc %? %@2152sc!1q0?
%f> 					if \(rset_find\(rs, buf, subs, 0\) >= 0\) \{
						buf\[subs\[0]] = xsep;
						buf\[subs\[1]-1] = '\''\\n'\'';5??0?
5??-13m 1220reg p OK vi.c:1774:a52sc %? %@2152sc!0?
1;2;3;4;5??!219reg vi.c:17742sc %? %@2132sc!0?
'\''1,#+12c 				if (!strcmp(xb_path, "/xref/") ||
						!strcmp(xb_path, "/grep/")) {
					int subs[2];	/* a header opens at its line */
					rset *rs = rset_smake(":[0-9]+(?::|\n)", 0);
??!219reg vi.c:1774:m12sc %? %@2142sc!b2%ya 98?0?
...
4??0?
4??+2m 1220reg p OK vi.c:1029:a42sc %? %@2152sc!0?
1;4??!219reg vi.c:10292sc %? %@2132sc!0?
?0?
%f+ 						vi_drawmsg_mpt\(ln\)
						break;
					}
...
%f+ 					temp_switch\(XREF_BUF, 0\);
					...
					vc_motion\(k\);2??0?
2??m 2220reg p OK vi.c:2244:a22sc %? %@2152sc!1q0?
;0fr.,$f+ ^					temp_switch\(XREF_BUF, 0\);$3??0?
3??m 2220reg p OK vi.c:2244:a32sc %? %@2152sc!fr 981qfr 980?
%f+ 						vi_drawmsg_mpt\(ln\)
						break;
					}4??0?
4??+3m 2220reg p OK vi.c:2244:a42sc %? %@2152sc!1q0?
%f+ 					vi_mod \|= 1;
				} else if \(k == '\''~'\'' \|\| k == '\''u'\'' \|\| k == '\''U'\''\)
					vc_motion\(k\);5??0?
5??-1m 2220reg p OK vi.c:2244:a52sc %? %@2152sc!0?
1;2;3;4;5??!219reg vi.c:22442sc %? %@2132sc!0?
...
??!219reg vi.c:1029:m12sc %? %@2142sc!0?
'\''2c 					if (!xref_refresh())
						temp_switch(XREF_BUF, 0);
??!219reg vi.c:2244:m22sc %? %@2142sc!p compat applied: src=splits.sh' > "$P2VIF".2
EXINIT='%ya 97:? %@97' $VI -e 'ex.c' 'vi.c' 'vi.h' "$P2VIF".0 "$P2VIF".1 "$P2VIF".2 "$P2VIF".d

exit 0
=== PATCH2VI DELTA ===
=== PATCH2VI COMPAT post src=grep.sh ===
=== GATE 1 present tag 1000 probe ex.c ===
struct buf tempbufs[4];		/* temporary buffers, for internal use */
=== END ===
...
index 000c9cdc..3cd0fba3 100644
--- a/vi.c
+++ b/vi.c
...
index 5a7e773a..2ef58d05 100644
--- a/vi.h
+++ b/vi.h
