...
if [ 1 ]; then
    ...
    p2vt0_0=0
    case " $applied2 " in *" grep.sh "*) p2vt0_0=1 ;; esac
    if [ $p2vt0_0 = 1 ]; then f231=1; fi
    p2vt1_0=0
    case " $applied2 " in *" splits.sh "*) p2vt1_0=1 ;; esac
...
'230reg '"$f230"'231reg '"$f231"'232reg '"$f232"'211reg fr 230f> 1??!? %@221fr 98b01b11b210?
...
# P2VI_COMPAT 1 f231 src=grep.sh
...
# P2VI_COMPAT 2 f232 src=splits.sh
