...
%f+ 	\{"p", ec_print},
	EO\(ai\),
	\{"ac", ec_setacreg},4??0?
4??+2m 3220reg p OK ex.c:1696:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"p", ec_print},.*?
	EO\(ai\),.*?
(	\{"ac", ec_setacreg},)7??0?
grp 07??m 3220reg p OK ex.c:1696:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	EO\(pr\),
	\{"pu", ec_put},
	\{"ph", ec_setenc},.*(	\{"e!", ec_edit},)
	\{"e", ec_edit},
	\{"ft", ec_ft},8??0?
grp 08??-4m 3220reg p OK ex.c:1696:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"bx", ec_setbufsmax},
	\{"b", ec_buffer},
	EO\(pac\),.*(	\{"fd", ec_setdir},)
	\{"fp", ec_setdir},
	EO\(fr\),9??0?
grp 09??-7m 3220reg p OK ex.c:1696:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:16962sc %? %@2132sc!0?
?0?
%f+ 	xgrec--;
}
...
m 01;0grp 1%f> 		} else
		...
		ec_edit\("", "e", s\);
		s = \*\(\+\+files\);9??0?
grp 09??-7m 4220reg p OK ex.c:1924:a92sc %? %@2152sc!'\''00?
...
%f+ 	if \(\(s = getenv\("EXINIT"\)\)\)
		ex_command\(s\)2??0?
2??m 5220reg p OK ex.c:1936:a22sc %? %@2152sc!1q0?
;0fr.,$f+ ^	if \(\(s = getenv\("EXINIT"\)\)\)$3??0?
3??m 5220reg p OK ex.c:1936:a32sc %? %@2152sc!fr 981qfr 980?
%f+ 		s = \*\(\+\+files\);
	} while \(--n > 0\);
	xvis &= ~4;4??0?
4??+3m 5220reg p OK ex.c:1936:a42sc %? %@2152sc!1q0?
;0fr.,$f+ ^		ex_command\(s\)$5??0?
5??-1m 5220reg p OK ex.c:1936:a52sc %? %@2152sc!fr 981qfr 980?
%f+ .........\+.ile..;
.. ..i...\(.-... ...
........ .4.
.....\(s.=......v..E..NIT...\)
...x..omm.n....6??0?
6??+3m 5220reg p OK ex.c:1936:a62sc %? %@2152sc!1q0?
grp 1%f+ 		s = \*\(\+\+files\);.*?
	} while \(--n > 0\);.*?
	xvis &= ~4;.*?
(	if \(\(s = getenv\("EXINIT"\)\)\))7??0?
grp 07??m 5220reg p OK ex.c:1936:a72sc %? %@2152sc!0?
1;2;3;4;5;6;7??!219reg ex.c:19362sc %? %@2132sc!0?
?0?
%f+ 		ex_command\(s\)
}1??0?
1??m 61q0?
;0fr.,$f+ ^		ex_command\(s\)$4??0?
4??m 6220reg p OK ex.c:1937:a42sc %? %@2152sc!fr 98fr 980?
1;4??!219reg ex.c:19372sc %? %@2132sc!0?
'\''1-1i int xexrc = 0;			/* read .exrc from the current directory */
??!219reg ex.c:0:m12sc %? %@2142sc!0?
'\''2i EO(exrc)
??!219reg ex.c:1653:m22sc %? %@2142sc!0?
'\''3i 	EO(exrc),
??!219reg ex.c:1696:m32sc %? %@2142sc!0?
...
'\''5s/\)\)\)/))) {/??!219reg ex.c:1936:m52sc %? %@2142sc!0?
'\''6i 	} else {
		char exrc[PATH_MAX];
...
??!219reg ex.c:1937:m62sc %? %@2142sc!vis 2b0w2q' > "$P2VIF"
...
index c10d3ad5..7ce0ca92 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1694,6 +1696,7 @@ static struct excmd {
 	{"p", ec_print},
 	EO(ai),
 	{"ac", ec_setacreg},
+	EO(exrc),
...
@@ -1933,6 +1985,29 @@ void ex_init(char **files, int n)
 		s = *(++files);
 	} while (--n > 0);
 	xvis &= ~4;
-	if ((s = getenv("EXINIT")))
