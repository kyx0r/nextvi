...
%f+ 	\{"p", ec_print},
	EO\(ai\),
	\{"ac", ec_setacreg},4??0?
4??+2m 3220reg p OK ex.c:1725:a42sc %? %@2152sc!1q0?
grp 1%f+ 	\{"p", ec_print},.*?
	EO\(ai\),.*?
(	\{"ac", ec_setacreg},)7??0?
grp 07??m 3220reg p OK ex.c:1725:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	EO\(pr\),
	\{"pu", ec_put},
	\{"ph", ec_setenc},.*(	\{"e!", ec_edit},)
	\{"e", ec_edit},
	\{"ft", ec_ft},8??0?
grp 08??-4m 3220reg p OK ex.c:1725:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"bx", ec_setbufsmax},
	\{"b", ec_buffer},
	EO\(pac\),.*(	\{"fd", ec_setdir},)
	\{"fp", ec_setdir},
	EO\(fr\),9??0?
grp 09??-7m 3220reg p OK ex.c:1725:a92sc %? %@2152sc!'\''00?
1;4;7;8;9??!219reg ex.c:17252sc %? %@2132sc!0?
?0?
%f+ 	xgrec--;
}
...
4??0?
4??+2m 4220reg p OK ex.c:1952:a42sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	}
	syn_setft\(xb_ft\);
	free\(sb->s\);.*(	ec_setbufsmax\(NULL, NULL, ""\);)
	char \*s = files\[0] \? files\[0] : "";
	do \{8??0?
grp 08??-4m 4220reg p OK ex.c:1952:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		} else
			esc = 0;
		sbuf_cut\(sb, 0\).*(		xmpt = 0;)
		ec_edit\("", "e", s\);
		s = \*\(\+\+files\);9??0?
grp 09??-7m 4220reg p OK ex.c:1952:a92sc %? %@2152sc!'\''00?
...
%f+ 		s = \*\(\+\+files\);
	...
	xvis &= ~4;4??0?
4??+3m 5220reg p OK ex.c:1964:a42sc %? %@2152sc!1q0?
;0fr.,$f+ ^		ex_command\(s\)$5??0?
5??-1m 5220reg p OK ex.c:1964:a52sc %? %@2152sc!fr 981qfr 980?
%f+ .........\+.ile..;
.. ..i...\(.-... ...
........ .4.
.....\(s.=......v..E..NIT...\)
...x..omm.n....6??0?
6??+3m 5220reg p OK ex.c:1964:a62sc %? %@2152sc!1q0?
grp 1%f+ 		s = \*\(\+\+files\);.*?
	} while \(--n > 0\);.*?
	xvis &= ~4;.*?
...
4??m 6220reg p OK ex.c:1965:a42sc %? %@2152sc!fr 98fr 980?
1;4??!219reg ex.c:19652sc %? %@2132sc!0?
'\''1-1i int xexrc = 0;			/* read .exrc from the current directory */
??!219reg ex.c:0:m12sc %? %@2142sc!0?
'\''2i EO(exrc)
??!219reg ex.c:1681:m22sc %? %@2142sc!0?
'\''3i 	EO(exrc),
??!219reg ex.c:1725:m32sc %? %@2142sc!0?
...
??!219reg ex.c:1952:m42sc %? %@2142sc!0?
'\''5s/\)\)\)/))) {/??!219reg ex.c:1964:m52sc %? %@2142sc!0?
'\''6i 	} else {
		char exrc[PATH_MAX];
...
??!219reg ex.c:1965:m62sc %? %@2142sc!vis 2b0w2q' > "$P2VIF"
...
index f86fb389..f5b6ba4a 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1723,6 +1725,7 @@ static struct excmd {
 	{"p", ec_print},
 	EO(ai),
 	{"ac", ec_setacreg},
+	EO(exrc),
...
@@ -1961,6 +2013,29 @@ void ex_init(char **files, int n)
 		s = *(++files);
 	} while (--n > 0);
 	xvis &= ~4;
-	if ((s = getenv("EXINIT")))
