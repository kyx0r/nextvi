...
%f+ 	\{"p", ec_print},
	EO\(ai\),
	\{"ac", ec_setacreg},3??0?
3??+2m 3220reg p OK ex.c:1689:a32sc %? %@2152sc!1q0?
grp 1%f+ 	\{"p", ec_print},.*?
	EO\(ai\),.*?
(	\{"ac", ec_setacreg},)7??0?
grp 07??m 3220reg p OK ex.c:1689:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	EO\(pr\),
	\{"pu", ec_put},
	\{"ph", ec_setenc},.*(	\{"e!", ec_edit},)
	\{"e", ec_edit},
	\{"ft", ec_ft},8??0?
grp 08??-4m 3220reg p OK ex.c:1689:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"bx", ec_setbufsmax},
	\{"b", ec_buffer},
	EO\(pac\),.*(	\{"fd", ec_setdir},)
	\{"fp", ec_setdir},
	EO\(fr\),9??0?
grp 09??-7m 3220reg p OK ex.c:1689:a92sc %? %@2152sc!'\''00?
1;3;7;8;9??!219reg ex.c:16892sc %? %@2132sc!0?
?0?
%f+ 	xgrec--;
}
...
3??0?
3??+2m 4220reg p OK ex.c:1918:a32sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	}
	syn_setft\(xb_ft\);
	free\(sb->s\);.*(	ec_setbufsmax\(NULL, NULL, ""\);)
	char \*s = files\[0] \? files\[0] : "";
	do \{8??0?
grp 08??-4m 4220reg p OK ex.c:1918:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		} else
			esc = 0;
		sbuf_cut\(sb, 0\).*(		xmpt = 0;)
		ec_edit\("", "e", s\);
		s = \*\(\+\+files\);9??0?
grp 09??-7m 4220reg p OK ex.c:1918:a92sc %? %@2152sc!'\''00?
...
%f+ 	if \(\(s = getenv\("EXINIT"\)\)\)
		ex_command\(s\)2??0?
2??m 5220reg p OK ex.c:1930:a22sc %? %@2152sc!1q0?
%f+ 		s = \*\(\+\+files\);
	} while \(--n > 0\);
	xvis &= ~4;3??0?
3??+3m 5220reg p OK ex.c:1930:a32sc %? %@2152sc!1q0?
;0fr.,$f+ ^	if \(\(s = getenv\("EXINIT"\)\)\)$4??0?
4??m 5220reg p OK ex.c:1930:a42sc %? %@2152sc!fr 981qfr 980?
;0fr.,$f+ ^		ex_command\(s\)$5??0?
5??-1m 5220reg p OK ex.c:1930:a52sc %? %@2152sc!fr 981qfr 980?
%f+ .........\+.ile..;
.. ..i...\(.-... ...
........ .4.
.....\(s.=......v..E..NIT...\)
...x..omm.n....6??0?
6??+3m 5220reg p OK ex.c:1930:a62sc %? %@2152sc!1q0?
grp 1%f+ 		s = \*\(\+\+files\);.*?
	} while \(--n > 0\);.*?
	xvis &= ~4;.*?
(	if \(\(s = getenv\("EXINIT"\)\)\))7??0?
grp 07??m 5220reg p OK ex.c:1930:a72sc %? %@2152sc!0?
1;2;3;4;5;6;7??!219reg ex.c:19302sc %? %@2132sc!0?
?0?
%f+ 		ex_command\(s\)
}1??0?
1??m 61q0?
;0fr.,$f+ ^		ex_command\(s\)$3??0?
3??m 6220reg p OK ex.c:1931:a32sc %? %@2152sc!fr 98fr 980?
1;3??!219reg ex.c:19312sc %? %@2132sc!0?
0?
...
'\''3i 	EO(exrc),
??!219reg ex.c:1689:m32sc %? %@2142sc!0?
...
??!219reg ex.c:1918:m42sc %? %@2142sc!0?
'\''5s/\)\)\)/))) {/??!219reg ex.c:1930:m52sc %? %@2142sc!0?
'\''6i 	} else {
		char exrc[PATH_MAX];
...
??!219reg ex.c:1931:m62sc %? %@2142sc!vis 2b0w2q' > "$P2VIF"
...
index 92efe600..af05d3f9 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
...
@@ -1687,6 +1689,7 @@ static struct excmd {
 	{"p", ec_print},
 	EO(ai),
 	{"ac", ec_setacreg},
+	EO(exrc),
...
@@ -1927,6 +1979,29 @@ void ex_init(char **files, int n)
 		s = *(++files);
 	} while (--n > 0);
 	xvis &= ~4;
-	if ((s = getenv("EXINIT")))
