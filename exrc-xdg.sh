...
=== PATCH2VI DELTA ===
=== DELTA ex.c ===
--- patch2vi_ff0hUm_ex.c.diff.orig	2026-04-23 11:49:40.824221974 -0100
+++ patch2vi_ff0hUm_ex.c.diff	2026-04-23 11:50:01.065694850 -0100
@@ -25,9 +25,7 @@
 #rel
 .,\$;f>
 === SEARCH PATTERN ===
...
index 36b8a6d6..bdbca1e6 100644
--- a/ex.c
+++ b/ex.c
...
@@ -1721,6 +1769,30 @@ void ex_init(char **files, int n)
 		s = *(++files);
 	} while (--n > 0);
 	xvis &= ~4;
-	if ((s = getenv("EXINIT")))
