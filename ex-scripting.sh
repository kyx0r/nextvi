...
3??0?
3??+2m 2220reg p OK ex.c:1559:a32sc %? %@2152sc!1q0?
m 01;0grp 1%f> 		ex_krsset\(sb->s, \+1\);
		free\(sb->s\);
	}.*(	if \(!val && !uc_isdigit\(\*arg\)\))
		return \(unsigned char\)\*arg;
	return val;8??0?
grp 08??-4m 2220reg p OK ex.c:1559:a82sc %? %@2152sc!'\''08??1q0?
...
grp 09??-15m 2220reg p OK ex.c:1559:a92sc %? %@2152sc!'\''00?
...
%f+ 	EO\(seq\),
	\{"sc!", ec_specials},
	\{"sc", ec_specials},3??0?
3??+2m 3220reg p OK ex.c:1662:a32sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(seq\),.*?
	\{"sc!", ec_specials},.*?
(	\{"sc", ec_specials},)7??0?
grp 07??m 3220reg p OK ex.c:1662:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},
	EO\(shape\),.*(	\{"ya!", ec_yank},)
	\{"ya\+", ec_yank},
	\{"ya", ec_yank},8??0?
grp 08??-4m 3220reg p OK ex.c:1662:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"w", ec_write},
	\{"uc", ec_setenc},
	\{"uz", ec_setenc},.*(	\{"cm!", ec_cmap},)
	\{"cm", ec_cmap},
	\{"cd", ec_chdir},9??0?
grp 09??-7m 3220reg p OK ex.c:1662:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1559:m22sc %? %@2142sc!0?
'\''3i 	{"sr", ec_script},
	{"sx", ec_script},
??!219reg ex.c:1662:m32sc %? %@2142sc!b1%ya 98?0?
%f> 			close\(pipefds1\[0]\);
			close\(pipefds1\[1]\);
		}
		execvp\(argv\[0], argv\);
...
index 82cd1654..55092a8b 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+char **xenvp;
...
@@ -1557,6 +1558,43 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
+
 ...
 {
 	int val = atoi(arg);
@@ -1660,6 +1698,8 @@ static struct excmd {
 	EO(seq),
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
+	{"sr", ec_script},
...
index 6466711d..ed60969a 100644
--- a/vi.h
+++ b/vi.h
@@ -1,4 +1,12 @@
