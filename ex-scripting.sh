...
${SEP}?%;f+ 	EO\\(seq\\),
	...
	\\{\"sc!\", ec_specials},
	\\{\"sc\", ec_specials},${ESC}${SEP}1??${ESC}${SEP}1??+2m 2${ESC}${ESC}${ESC}${SEP}${OK1}p OK ex.c:1636:a1${ESC}${ESC}${ESC}${SEP}1q${ESC}${SEP}grp 1${ESC}${SEP}%;f+ 	EO\\(seq\\),.*?
	\\{\"sc!\", ec_specials},.*?
(	\\{\"sc\", ec_specials},)${ESC}${SEP}grp 0${ESC}${SEP}2??${ESC}${SEP}2??m 2${ESC}${ESC}${ESC}${SEP}${OK1}p OK ex.c:1636:a2${SEP}${LB}
...
${SEP}'2a 	{\"sr\", ec_script},
	{\"sx\", ec_script},
${SEP}??!${DBG2:-ya!112${ESC}${SEP}prp${ESC}${SEP}p FAIL ex.c:1636:m2${ESC}${SEP}pr${INTR}${QF2}}${SEP}b1${SEP}%ya 98${SEP}?%;f> 			close\\(pipefds1\\[0\\]\\);
			close\\(pipefds1\\[1\\]\\);
		}
		execvp\\(argv\\[0\\], argv\\);
		exit\\(1\\);
