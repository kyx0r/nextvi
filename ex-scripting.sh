...
4??0?
4??+2m 2220reg p OK ex.c:1638:a42sc %? %@2152sc!1q0?
...
grp 08??-13m 2220reg p OK ex.c:1638:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		ex_regesc\(sb, reg\.s, reg\.s \+ reg\.s_n, 1\);
		free\(reg\.s\);
		sbuf_nul\(sb\).*(_EO\(left,)
	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);9??0?
grp 09??-20m 2220reg p OK ex.c:1638:a92sc %? %@2152sc!'\''00?
...
%f+ 	EO\(seq\),
	\{"sc!", ec_specials},
	\{"sc", ec_specials},4??0?
4??+2m 3220reg p OK ex.c:1740:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(seq\),.*?
	\{"sc!", ec_specials},.*?
(	\{"sc", ec_specials},)7??0?
...
index c10d3ad5..6509d5be 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+char **xenvp;
...
@@ -1636,6 +1637,43 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1738,6 +1776,8 @@ static struct excmd {
 	EO(seq),
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
+	{"sr", ec_script},
