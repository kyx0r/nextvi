...
grp 09??-17m 2220reg p OK ex.c:1669:a92sc %? %@2152sc!'\''00?
...
'\''3i 	{"sr", ec_script},
	{"sx", ec_script},
??!219reg ex.c:1774:m32sc %? %@2142sc!b1m!%ya 98?0?
%f> 			close\(pipefds1\[0]\);
			close\(pipefds1\[1]\);
		}
		execvp\(argv\[0], argv\);
...
index 14fe45dc..5004584b 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+char **xenvp;
...
@@ -1772,6 +1810,8 @@ static struct excmd {
 	EO(seq),
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
+	{"sr", ec_script},
