...
%f+ 	EO\(seq\),
	\{"sc!", ec_specials},
	\{"sc", ec_specials},4??0?
4??+2m 3220reg p OK ex.c:1804:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(seq\),.*?
	\{"sc!", ec_specials},.*?
(	\{"sc", ec_specials},)7??0?
grp 07??m 3220reg p OK ex.c:1804:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},
	EO\(shape\),.*(	\{"ya!", ec_yank},)
	\{"ya\+", ec_yank},
	\{"ya", ec_yank},8??0?
grp 08??-4m 3220reg p OK ex.c:1804:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"w", ec_write},
	\{"uc", ec_setenc},
	\{"uz", ec_setenc},.*(	\{"cm!", ec_cmap},)
	\{"cm", ec_cmap},
	\{"cd", ec_chdir},9??0?
grp 09??-7m 3220reg p OK ex.c:1804:a92sc %? %@2152sc!'\''00?
...
'\''3i 	{"sr", ec_script},
	{"sx", ec_script},
??!219reg ex.c:1804:m32sc %? %@2142sc!b1m!%ya 98?0?
%f> 			close\(pipefds1\[0]\);
			close\(pipefds1\[1]\);
		}
		execvp\(argv\[0], argv\);
...
index f0ce0805..426ba19c 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+char **xenvp;
...
@@ -1668,6 +1669,43 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
+
 ...
 {
 	ren_state *r = x->r;
@@ -1802,6 +1840,8 @@ static struct excmd {
 	EO(seq),
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
+	{"sr", ec_script},
