...
grp 08??-13m 2220reg p OK ex.c:1647:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		ex_regesc\(sb, reg\.s, reg\.s \+ reg\.s_n, 1\);
		free\(reg\.s\);
		sbuf_nul\(sb\).*(_EO\(left,)
	if \(\*loc\)
		xleft = \(xcols / 2\) \* atoi\(loc\);9??0?
grp 09??-20m 2220reg p OK ex.c:1647:a92sc %? %@2152sc!'\''00?
...
'\''3i 	{"sr", ec_script},
	{"sx", ec_script},
??!219reg ex.c:1750:m32sc %? %@2142sc!b1m!%ya 98?0?
%f> 			close\(pipefds1\[0]\);
			close\(pipefds1\[1]\);
		}
		execvp\(argv\[0], argv\);
...
index 4efc8c2e..ecc7deda 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,4 @@
+char **xenvp;
...
@@ -1645,6 +1646,43 @@ static void *ec_krsset(char *loc, char *cmd, char *arg)
...
@@ -1748,6 +1786,8 @@ static struct excmd {
 	EO(seq),
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
+	{"sr", ec_script},
