...
%f+ 	EO\(ish\),
	\{"inc", ec_setincl},
	EO\(ic\),3??0?
3??+2m 3220reg p OK ex.c:1635:a32sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(ish\),.*?
	\{"inc", ec_setincl},.*?
(	EO\(ic\),)7??0?
grp 07??m 3220reg p OK ex.c:1635:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"f>", ec_find},
	\{"f<", ec_find},
	\{"f", ec_fuzz},.*(	\{"g!", ec_glob},)
	\{"g", ec_glob},
	EO\(mpt\),8??0?
grp 08??-4m 3220reg p OK ex.c:1635:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	EO\(fr\),
	\{"f\+", ec_find},
	\{"f-", ec_find},.*(	\{"m", ec_mark},)
	\{"q!", ec_quit},
	\{"q", ec_quit},9??0?
grp 09??-7m 3220reg p OK ex.c:1635:a92sc %? %@2152sc!'\''00?
1;3;7;8;9??!219reg ex.c:16352sc %? %@2132sc!0?
?0?
%f+ 	\{"g", ec_glob},
	EO\(mpt\),
	\{"m", ec_mark},
...
%f+ 	\{"g", ec_glob},
	EO\(mpt\),
	\{"m", ec_mark},3??0?
3??+2m 4220reg p OK ex.c:1642:a32sc %? %@2152sc!1q0?
grp 1%f+ 	\{"g", ec_glob},.*?
	EO\(mpt\),.*?
(	\{"m", ec_mark},)7??0?
grp 07??m 4220reg p OK ex.c:1642:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"d", ec_delete},
	EO\(grp\),
	\{"g!", ec_glob},.*(	\{"reg", ec_regprint},)
	\{"re", ec_krsset},
	\{"rd", ec_undoredo},8??0?
grp 08??-4m 4220reg p OK ex.c:1642:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"inc", ec_setincl},
	EO\(ic\),
	\{"i", ec_insert},.*(	EO\(rr\),)
	\{"r", ec_read},
	\{"wq!", ec_write},9??0?
grp 09??-7m 4220reg p OK ex.c:1642:a92sc %? %@2152sc!'\''00?
...
'\''3i 	{"im!", ec_map},
	{"im", ec_map},
??!219reg ex.c:1635:m32sc %? %@2142sc!0?
'\''4i 	{"nm!", ec_map},
	{"nm", ec_map},
??!219reg ex.c:1642:m42sc %? %@2142sc!b2%ya 98?0?
%f> 	do \{
...
index 82cd1654..7245a3d1 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,5 @@
...
+
 ...
 {
 	int n = atoi(arg);
@@ -1633,6 +1675,8 @@ static struct excmd {
 	EO(ish),
 	{"inc", ec_setincl},
 	EO(ic),
+	{"im!", ec_map},
+	{"im", ec_map},
 	...
 	{"d", ec_delete},
 	EO(grp),
@@ -1640,6 +1684,8 @@ static struct excmd {
 	{"g", ec_glob},
 	EO(mpt),
 	{"m", ec_mark},
+	{"nm!", ec_map},
...
index eb6ec78d..c833aa1a 100644
--- a/led.c
+++ b/led.c
