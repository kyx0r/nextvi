...
%f+ 	EO\(ish\),
	\{"inc", ec_setincl},
	EO\(ic\),4??0?
4??+2m 3220reg p OK ex.c:1722:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(ish\),.*?
	\{"inc", ec_setincl},.*?
(	EO\(ic\),)7??0?
...
'\''4i 	{"nm!", ec_map},
	{"nm", ec_map},
??!219reg ex.c:1730:m42sc %? %@2142sc!b2m!%ya 98?0?
%f> 	do \{
...
index bf37a9ce..57935153 100644
--- a/conf.c
+++ b/conf.c
...
index 4efc8c2e..99db1f90 100644
--- a/ex.c
+++ b/ex.c
@@ -1,3 +1,5 @@
...
+
 ...
 {
 	int n = atoi(arg);
@@ -1720,6 +1762,8 @@ static struct excmd {
 	EO(ish),
 	{"inc", ec_setincl},
 	EO(ic),
+	{"im!", ec_map},
+	{"im", ec_map},
 	...
 	{"d", ec_delete},
 	EO(grp),
@@ -1728,6 +1772,8 @@ static struct excmd {
 	EO(mpt),
 	{"m!", ec_mark},
 	{"m", ec_mark},
+	{"nm!", ec_map},
