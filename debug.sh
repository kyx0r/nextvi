...
4??0?
4??+2m 1220reg p OK ex.c:1949:a42sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	}
	syn_setft\(xb_ft\);
	free\(sb->s\);.*(	ec_setbufsmax\(NULL, NULL, ""\);)
	char \*s = files\[0] \? files\[0] : "";
	do \{8??0?
grp 08??-4m 1220reg p OK ex.c:1949:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 		} else
			esc = 0;
		sbuf_cut\(sb, 0\).*(		xmpt = 0;)
		ec_edit\("", "e", s\);
		s = \*\(\+\+files\);9??0?
grp 09??-7m 1220reg p OK ex.c:1949:a92sc %? %@2152sc!'\''00?
...
??!219reg ex.c:1949:m12sc %? %@2142sc!b1m!%ya 98?0?
...
index f049069e..f0fde14d 100644
--- a/ex.c
+++ b/ex.c
@@ -1947,6 +1947,22 @@ void ex(void)
 	xgrec--;
 }
