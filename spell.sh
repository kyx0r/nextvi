...
m 01;0grp 1%f> 	\{ex_ft, "\.\+", A\(AY1 \| SYN_BD\), 1},
	\{ex_ft, ":\[ \\t]\*\(\(\(\(\?:\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\(\?:\(\?:<\(\?:\[\^<\\\\\\\\]\|\\\\\\\\\.\?\)\*<\?\|>\(\?:\[\^>\\\\\\\\]\|\\\\\\\\\.\?\)\*>\?\)\|\\
\(\?:'\''\[0-9]\+\)\|\(\[\.%\$]\|\[0-9 \\t]\*\)\?\)\)\(\?:\(\[-\*-\+/%]\)\[ \\t]\*\[0-9]\+\[ \\t]\*\)\*\(\?:\[ \\t]\*\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\)\[ \\t]\*\\.*(		A\(SYN_BD, BL1, WH1, GR1, RE1, WH1, YE\)},)
	\{vs_ft, "\(\\\\\\\\\)\(\.\)\(\?:\(-\)\(\?:\(\\\\\\\\\(\.\)\)\|\[\^\\\\\\\\\\\\]]\)\)\?\|\[\^\\\\\\\\\[\^]\(-\)\(\?:\(\\\\\\\\\(\.\)\)\|\.\)\|\\
\[\^\\\\\\\\\[\^]\\\\\^\(-\)\(\?:\(\\\\\\\\\(\.\)\)\|\[\^\\\\\\\\]\)\|\\\\\^\(-\)\[\^\\\\\\\\]",8??0?
...
%f+ 		A\(BL1 \| SYN_BD, RE, RE, RE, RE, WH1, MA1, RE, RE, WH1, RE, GR1, CY1, MA1\)},
	\{ex_ft, "\\\\\\\\\(\.\)", A\(AY1 \| SYN_BD, YE\)},
	\{ex_ft, "!\(\?:\[\^!\\\\\\\\]\|\\\\\\\\\.\?\)\*!\?\|%\(\?:#\|\[0-9]\+\|@\(\[0-9]\+\)\)\?", A\(WH1 \| SYN_BD, CY1\)},4??0?
4??+2m 18220reg p OK conf.c:305:a42sc %? %@2152sc!1q0?
grp 1%f+ 		A\(BL1 \| SYN_BD, RE, RE, RE, RE, WH1, MA1, RE, RE, WH1, RE, GR1, CY1, MA1\)},.*?
	\{ex_ft, "\\\\\\\\\(\.\)", A\(AY1 \| SYN_BD, YE\)},.*?
(	\{ex_ft, "!\(\?:\[\^!\\\\\\\\]\|\\\\\\\\\.\?\)\*!\?\|%\(\?:#\|\[0-9]\+\|@\(\[0-9]\+\)\)\?", A\(WH1 \| SYN_BD, CY1\)},)7??0?
grp 07??m 18220reg p OK conf.c:305:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{ex_ft, "\.\+", A\(AY1 \| SYN_BD\), 1},
	\{ex_ft, ":\[ \\t]\*\(\(\(\(\?:\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\(\?:\(\?:<\(\?:\[\^<\\\\\\\\]\|\\\\\\\\\.\?\)\*<\?\|>\(\?:\[\^>\\\\\\\\]\|\\\\\\\\\.\?\)\*>\?\)\|\\
\(\?:'\''\[0-9]\+\)\|\(\[\.%\$]\|\[0-9 \\t]\*\)\?\)\)\(\?:\(\[-\*-\+/%]\)\[ \\t]\*\[0-9]\+\[ \\t]\*\)\*\(\?:\[ \\t]\*\\\\\|\(\?:\[\^\|\\\\\\\\]\|\\\\\\\\\.\?\)\*\\\\\|\?\[ \\t]\*\)\*\)\[ \\t]\*\\.*(		A\(SYN_BD, BL1, WH1, GR1, RE1, WH1, YE\)},)
	\{vs_ft, "\(\\\\\\\\\)\(\.\)\(\?:\(-\)\(\?:\(\\\\\\\\\(\.\)\)\|\[\^\\\\\\\\\\\\]]\)\)\?\|\[\^\\\\\\\\\[\^]\(-\)\(\?:\(\\\\\\\\\(\.\)\)\|\.\)\|\\
...
1;4;7;8;9??!219reg conf.c:3052sc %? %@2132sc!0?
?0?
...
2??m 19220reg p OK conf.c:329:a22sc %? %@2152sc!1q0?
;0fr.,$f+ ^const int hlopts\[] = \{1, 2};$3??0?
3??m 19220reg p OK conf.c:329:a32sc %? %@2152sc!fr 981qfr 980?
%f+ const int hlslen = LEN\(hls\);

/\* ids of optional hls, reset and reloaded on filetype change \*/4??0?
4??+3m 19220reg p OK conf.c:329:a42sc %? %@2152sc!1q0?
%f+ const int hloptslen = LEN\(hlopts\);

/\* how to highlight text in the reverse direction \*/5??0?
5??-1m 19220reg p OK conf.c:329:a52sc %? %@2152sc!1q0?
%f+ ....t...t.h........L........
...
.. ....to h.g.....t..e....................r......../6??0?
6??+3m 19220reg p OK conf.c:329:a62sc %? %@2152sc!1q0?
grp 1%f+ const int hlslen = LEN\(hls\);.*?
.*?
/\* ids of optional hls, reset and reloaded on filetype change \*/.*?
(const int hlopts\[] = \{1, 2};)7??0?
grp 07??m 19220reg p OK conf.c:329:a72sc %? %@2152sc!1q0?
...
m 01;0grp 1%f> 	\{bar_ft, "\^\(\\"\.\*\\"\)\.\*\(\\\\\[\[wrf]\\\\]\)\.\*\$", A\(AY1 \| SYN_BD, BL, RE\)},
	...
	\{"\^\[" CR2L "]", -1},
	\{"\^\[a-zA-Z_0-9]", \+1},9??0?
grp 09??-11m 19220reg p OK conf.c:329:a92sc %? %@2152sc!'\''00?
...
'\''18i 	{ex_ft, NULL, SP, 9, 5},
??!219reg conf.c:305:m182sc %? %@2142sc!0?
'\''19s/2}/2, 5}/??!219reg conf.c:329:m192sc %? %@2142sc!b1m!%ya 98?0?
%f> 	return NULL;
}
...
%f+ 	EO\(seq\),
	\{"sc!", ec_specials},
	\{"sc", ec_specials},4??0?
4??+2m 2220reg p OK ex.c:1802:a42sc %? %@2152sc!1q0?
grp 1%f+ 	EO\(seq\),.*?
	\{"sc!", ec_specials},.*?
(	\{"sc", ec_specials},)7??0?
grp 07??m 2220reg p OK ex.c:1802:a72sc %? %@2152sc!1q0?
m 01;0grp 1%f> 	\{"ub", ec_setenc},
	\{"ud", ec_undoredo},
	EO\(shape\),.*(	\{"ya!", ec_yank},)
	\{"ya\+", ec_yank},
	\{"ya", ec_yank},8??0?
grp 08??-4m 2220reg p OK ex.c:1802:a82sc %? %@2152sc!'\''08??1q0?
m 01;0grp 1%f> 	\{"w", ec_write},
	\{"uc", ec_setenc},
	\{"uz", ec_setenc},.*(	\{"cm!", ec_cmap},)
	\{"cm", ec_cmap},
	\{"cd", ec_chdir},9??0?
grp 09??-7m 2220reg p OK ex.c:1802:a92sc %? %@2152sc!'\''00?
...
'\''2i 	{"sl!", ec_spell},
	{"sl", ec_spell},
??!219reg ex.c:1802:m22sc %? %@2142sc!b2m!%ya 98?0?
%f> 	return cs\[0] == '\''\\n'\'' \? 1 : 2;
}
...
@@ -298,11 +341,12 @@ return|select|switch|type|var))\\>", A(GR1, BL1 | SYN_BD, YE1)},
 (?:([,;]#?)[ \t]*((?:\\|(?:[^|\\\\]|\\\\.?)*\\|?[ \t]*)*(?:(?:<(?:[^<\\\\]|\\\\.?)*<?|>(?:[^>\\\\]|\\\\.?)*>?)|\
 (?:'[0-9]+)|([.$]|[0-9 \t]*)?))(?:([-*-+/%])[ \t]*([0-9]+)[ \t]*)*(?:[ \t]*\\|(?:[^|\\\\]|\\\\.?)*\\|?)*[ \t]*)*)\
 ((pac|pr|ai|ish|err|fr|ic|grp|mpt|rr|shape|seq|ts|td|order|hl[lwpr]?|left|lim|led|vis)\
-|[@&!dj]|m!?|=\\?{0,1}|\\?~|\\?{1,2}[?!]?|b[psx]?|p[uh]?|ac|e[f!]?!?|f[-+><tdp]?|inc|i|sc!?|\
...
+	{ex_ft, NULL, SP, 9, 5},
 	...
 	{vs_ft, ".+", A(AY1 | SYN_BD), 1},
 	{vs_ft, "(^[?/])|(\\\\[<>]|\\(\\?[:=!<>#]|\\[\\^?((?:\\\\.?|[^\\]])*)]|\\[|[.^$\\()*+|?]|\\{([0-9]*(,)?[0-9]*)?}?)|\\\\(.)",
@@ -326,7 +370,7 @@ return|select|switch|type|var))\\>", A(GR1, BL1 | SYN_BD, YE1)},
...
index 0ce81414..61e353d8 100644
--- a/ex.c
+++ b/ex.c
...
+
 ...
 {
 	if (arg[0])
@@ -1800,6 +1964,8 @@ static struct excmd {
 	EO(seq),
 	{"sc!", ec_specials},
 	{"sc", ec_specials},
+	{"sl!", ec_spell},
