...
# Available separators: 0001 0002 0003 0004 0005 0006 0007 0010 0013 0014 0016 0017 0020 0021 0022 0023 0024 0025 0026 0027 0030 0031 0032 0033 0034 0035 0036 0037 0102 0103 0104 0105 0107 0110 0112 0113 0117 0120 0121 0122 0123 0124 0126 0127 0130 0131 0132 0136 0176 0177 0200 0201 0202 0203 0204 0205 0206 0207 0210 0211 0212 0213 0214 0215 0216 0217 0220 0221 0222 0223 0224 0225 0226 0227 0230 0231 0232 0233 0234 0235 0236 0237 0240 0241 0242 0243 0244 0245 0246 0247 0250 0251 0252 0253 0254 0255 0256 0257 0260 0261 0262 0263 0264 0265 0266 0267 0270 0271 0272 0273 0274 0275 0276 0277 0300 0301 0302 0303 0304 0305 0306 0307 0310 0311 0312 0313 0314 0315 0316 0317 0320 0321 0322 0323 0324 0325 0326 0327 0330 0331 0332 0333 0334 0335 0336 0337 0340 0341 0342 0343 0344 0345 0346 0347 0350 0351 0352 0353 0354 0355 0356 0357 0360 0361 0362 0363 0364 0365 0366 0367 0370 0371 0372 0373 0374 0375 0376 0377
set -e
...
EXINIT="rcm:|sc! \\\\${SEP}|vis 3${SEP}%;f> 	o = off\\\\[i\\\\]; \\\\\\\\
	if \\\\(o >= 0\\\\) \\\\{ \\\\\\\\
		for \\\\(l = i; off\\\\[i\\\\] == o; i\\\\+\\\\+\\\\); \\\\\\\\${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 117\\${SEP}${QF}}${SEP};=
${SEP}+3${SEP}s/bound \\\\? ctt\\\\[atti\\\\+\\\\+\\\\] : //${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 117\\${SEP}${QF}}${SEP}.,\$;f> 		return;
	ren_state \\\\*r = ren_position\\\\(s0\\\\);
	int j, c, l, i, o, n = r->n;${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 148\\${SEP}${QF}}${SEP};=
...
${SEP}.,\$;f> 		for \\\\(c = cbeg; c < cend; c\\\\+\\\\+\\\\)
	...
	\\\\}${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 165\\${SEP}${QF}}${SEP};=
${SEP}+3,#+38d${SEP}.,\$f> 	if \\\\(xhl\\\\)${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 205\\${SEP}${QF}}${SEP};=
${SEP}+1,#+1c 		syn_highlight(att, s0, n);
.
${SEP}.,\$;f> 		for \\\\(; \\\\(char\\\\*\\\\)p < &led_attsb->s\\\\[led_attsb->s_n\\\\]; p\\\\+\\\\+\\\\) \\\\{
			if \\\\(p->s != s0 && p->s\\\\)
				continue;${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 212\\${SEP}${QF}}${SEP};=
${SEP}+3,#+18c 			att[p->off] = syn_merge(att[p->off], p->att);
.
${SEP}.,\$;f> 				continue;
			if \\\\(r->pos\\\\[o \\\\+ 1\\\\] \\\\+ r->wid\\\\[o \\\\+ 1\\\\] != r->pos\\\\[o\\\\]\\\\)
				continue;${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 243\\${SEP}${QF}}${SEP};=
${SEP}+3${SEP}s/bound \\\\? ctt\\\\[l-1\\\\] : //${SEP}??!${DBG:--5,+5p\\${SEP}p FAIL line 243\\${SEP}${QF}}${SEP}vis 2${SEP}wq" $VI -e 'led.c'

exit 0
=== PATCH2VI DELTA ===
=== PATCH2VI PATCH ===
diff --git a/led.c b/led.c
index e85c962e..5016cf44 100644
--- a/led.c
+++ b/led.c
