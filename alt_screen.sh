...
# Available separators: 
set -e
...
\\\\}
${SEP}??!${DBG:-.-5,.+5p\\${SEP}p FAIL line 50\\${SEP}vis 4\\${SEP}q! 1}${SEP};=
${SEP}.+2a void term_scrl(void)
{
	term_write(\"\\\\x1b[?1049l\", 8);	/* leave alternate screen */
}
...
# Patch: vi.c
SEP="$(printf '\x01')"
EXINIT="rcm:|sc! \\\\${SEP}|vis 6${SEP}%;f> 				else if \\\\(k == 'z'\\\\) \\\\{
					xquit = texec == '&' \\\\? -1 : 1;
					term_push\\\\(\"\\\\\\\\n\", 1\\\\);${SEP}??!${DBG:-.-5,.+5p\\${SEP}p FAIL line 1662\\${SEP}vis 4\\${SEP}q! 1}${SEP};=
${SEP}.+2a 				} else if (k == 'x') {
					xquit = texec == '&' ? -1 : 1;
					if (xgrec == 1)
						term_scrl();
