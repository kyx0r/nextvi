...
.	.f.\\(.....
...b.e...r.........\\(..\\[............\\*\\(\\?:\\[.............,..\\).
.	i.t s..s.....o...${ESC}${SEP}5??${ESC}${SEP}5??+3m 0${ESC}${ESC}${ESC}${SEP}${OK1}p OK vi.c:611:a5${SEP}${LB}
${SEP}0;1;2;3;4;5??!${DBG1:-ya!112${ESC}${SEP}prp${ESC}${SEP}p FAIL vi.c:611${ESC}${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}?%;f+ 	case '}':
	case '\\[':
	case '\\]':
		dir = mv == '\\{' \\|\\| mv == '\\[' \\? 1 : -1;
...
..v.r.= ...=....' \\|. ....=...'.. .....: ....
	.f...\\(. = ........n.;.i.\\+.
		......b.f.........e................of.. ...\\).
	.	..re..;${ESC}${SEP}5??${ESC}${SEP}5??+3m 1${ESC}${ESC}${ESC}${SEP}${OK1}p OK vi.c:651:a5${SEP}${LB}
${SEP}0;1;2;3;4;5??!${DBG1:-ya!112${ESC}${SEP}prp${ESC}${SEP}p FAIL vi.c:651${ESC}${SEP}pr${INTR}${QF1}}${SEP}${LB}
${SEP}${LB}
